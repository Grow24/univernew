...
import { CellValueType as re, isTextFormat as Rs, isRealNum as Ds, isBooleanString as Do, willLoseNumericPrecision as Mi, CommandType as v, IUniverInstanceService as M, Tools as A, createInterceptorKey as Rt, Disposable as ue, UniverInstanceType as B, InterceptorEffectEnum as he, InterceptorManager as As, toDisposable as Ne, remove as je, composeInterceptors as _i, DisposableCollection as kt, BooleanNumber as te, HorizontalAlign as xs, BorderStyleTypes as Ao, Inject as $, IResourceManagerService as Cn, RTree as yi, generateRandomId as Ut, insertMatrixArray as Nn, ObjectMatrix as Y, Rectangle as N, moveMatrixArray as xo, sliceMatrixArray as $o, concatMatrixArray as Wo, spliceArray as Vo, Range as X, normalizeTextRuns as bi, isSafeNumeric as Ei, RANGE_TYPE as j, createRowColIter as ki, ICommandService as E, IUndoRedoService as V, RxDisposable as Lo, sequenceExecute as L, selectionToArray as Ui, createIdentifier as $s, IContextService as Ho, ErrorService as Lt, LocaleService as it, cellToRange as Fo, PermissionStatus as q, IPermissionService as Ze, isICellData as Bo, mapObjectMatrix as Ti, Dimension as Re, getArrayLength as jo, Direction as pe, Injector as as, queryObjectMatrix as at, CellModeEnum as Pi, IConfigService as pn, cloneWorksheetData as Ni, mergeWorksheetSnapshotWithDefault as Oi, BorderType as de, FontWeight as Di, FontItalic as Ai, ILogService as zo, DocumentDataModel as xi, BuildTextUtils as $i, TextX as Wi, CustomCommandExecutionError as Vi, IAuthzIoService as Li, UserManagerService as Hi, LRUMap as Fi, Optional as Bi, isDefaultFormat as ji, DependentOn as zi, Plugin as Gi, merge as Ki, IS_ROW_STYLE_PRECEDE_COLUMN_STYLE as Ji, AUTO_HEIGHT_FOR_MERGED_CELLS as qi, registerDependencies as Yi, mergeOverrideWithDependencies as Xi, touchDependencies as _n } from "@univerjs/core";
import { Subject as De, BehaviorSubject as mt, merge as zt, shareReplay as Zi, takeUntil as et, switchMap as tt, of as Ie, distinctUntilChanged as Qi, skip as Go, map as Es, first as ea, filter as oo } from "rxjs";
import { SetDefinedNameMutation as tn, RemoveDefinedNameMutation as On, SetDefinedNameMutationFactory as ta, IDefinedNamesService as Ko, LexerTreeBuilder as na, operatorToken as sa, deserializeRangeWithSheet as oa, sequenceNodeType as ra, deserializeRangeWithSheetWithCache as ia, SetFormulaCalculationResultMutation as aa, handleNumfmtInCell as ua, stripErrorMargin as la, UniverFormulaEnginePlugin as ca } from "@univerjs/engine-formula";
...
}, fa = Rt("CELL_CONTENT"), Ra = Rt("ROW_FILTERED"), ht = {
  CELL_CONTENT: fa,
  ROW_FILTERED: Ra
};
...
const co = Rt("BEFORE_CELL_EDIT"), Cs = Rt("AFTER_CELL_EDIT"), ps = Rt("VALIDATE_CELL");
let G = class extends ue {
  ...
  _interceptWorkbook(e) {
    const t = new kt(), s = e.getUnitId(), o = this, r = (i) => {
...
}, Na = new Ct("default", qo), Oa = new Ct("default-last-row", {
  ...qo,
  lastRowStyle: {
    bd: {
      t: {
...
let ve = class extends ue {
  ...
  registerRangeThemeRule(e, t) {
    const { unitId: s, subUnitId: o, range: r } = t, i = Ut(), a = this._ensureRangeThemeStyleRuleMap(s), u = this._ensureRTreeCollection(s);
...
const nn = {
  ...
  handler: (n, e) => {
    ...
    for (let f = d; f < d + h; f++)
      r ? Nn(f, (m = r[f - o.startRow]) != null ? m : c, l) : Nn(f, c, l);
  ...
  handler: (n, e) => {
    ...
    for (let f = c; f < c + d; f++) {
      ...
      a ? Nn(f, (m = a[f - i.startColumn]) != null ? m : C, l) : Nn(f, C, l);
    }
...
function mu(n, e, t, s) {
  ...
  return u ? (n.startColumn = n.startColumn - t, {
    ...
    spanAnchor: N.simpleRangesIntersect(n, a) ? a : null,
    hasValue: !1,
    range: n
  } : {
    spanAnchor: null,
...
function pu({
  ...
  allMatrixWithSpan: e,
  directions: t,
  isWorksheetHasSpan: s,
  maxRow: o,
  maxColumn: r
}) {
  const { left: i, right: a, up: u, down: l } = t, { startRow: c, startColumn: d, endRow: h, endColumn: g } = n;
  let m = !1;
  if (i && u && c > 0 && d > 0) {
    const f = e.getValue(c - 1, d - 1);
    gt(f, e) && (s && f.spanAnchor ? (n.startRow = f.spanAnchor.startRow, n.startColumn = f.spanAnchor.startColumn) : (n.startRow = c - 1, n.startColumn = d - 1), m = !0);
  }
  if (a && u && c > 0 && g < r - 1) {
    const f = e.getValue(c - 1, g + 1);
    gt(f, e) && (s && f.spanAnchor ? (n.startRow = f.spanAnchor.startRow, n.endColumn = f.spanAnchor.endColumn) : (n.startRow = c - 1, n.endColumn = g + 1), m = !0);
  }
  if (i && l && h < o - 1 && d > 0) {
    const f = e.getValue(h + 1, d - 1);
    gt(f, e) && (s && f.spanAnchor ? (n.endRow = f.spanAnchor.endRow, n.startColumn = f.spanAnchor.startColumn) : (n.endRow = h + 1, n.startColumn = d - 1), m = !0);
  }
  if (a && l && h < o - 1 && g < r - 1) {
    const f = e.getValue(h + 1, g + 1);
    gt(f, e) && (s && f.spanAnchor ? (n.endRow = f.spanAnchor.endRow, n.endColumn = f.spanAnchor.endColumn) : (n.endRow = h + 1, n.endColumn = g + 1), m = !0);
  }
  return {
    hasValue: m,
    range: n
...
function Ph(n, e, t) {
  ...
  for (; d; ) {
    d = !1;
    const m = pu({ range: h, allMatrixWithSpan: r, directions: e, isWorksheetHasSpan: i, maxRow: s, maxColumn: o });
    if (m.hasValue) {
      h = m.range, d = !0;
      continue;
    }
    if (l && h.startRow !== 0) {
      const { hasValue: f, range: C, spanAnchor: p } = Ru(h, r, 1, i);
      if (p && g.push(p), f) {
        h = C, d = !0;
        continue;
      }
    ...
    if (c && h.endRow !== s - 1) {
      const { hasValue: f, range: C, spanAnchor: p } = Cu(h, r, 1, i);
      if (p && g.push(p), f) {
        h = C, d = !0;
        continue;
      }
    ...
    if (a && h.startColumn !== 0) {
      const { hasValue: f, range: C, spanAnchor: p } = mu(h, r, 1, i);
      if (p && g.push(p), f) {
        h = C, d = !0;
        continue;
      }
    ...
    if (u && h.endColumn !== o - 1) {
      const { hasValue: f, range: C, spanAnchor: p } = fu(h, r, 1, i);
      if (p && g.push(p), f) {
        h = C, d = !0;
        continue;
      }
...
const Su = (n) => {
  ...
  let t = fo(n);
  for (; t.area > 0; )
    t.range && (e.push(t.range), Iu(n, t.range)), t = fo(n);
  return e;
}, nr = (n) => {
  const e = Su(n);
  return tr(e);
...
class Nh {
  ...
  merge() {
    const e = wu(this._matrix);
    return tr(e);
  }
}
const Oh = 1.5, Dh = "rgba(255, 255, 255, 0.01)";
function Ah(n) {
  ...
  return t != null && (o.primary = vu(t)), o;
}
function vu(n) {
...
var Mu = /* @__PURE__ */ ((n) => (n[n.Tab = 1] = "Tab", n[n.Comma = 2] = "Comma", n[n.Semicolon = 4] = "Semicolon", n[n.Space = 8] = "Space", n[n.Custom = 16] = "Custom", n))(Mu || {});
class _u {
  constructor() {
    R(this, "_tabCount", 0);
...
function Uu(n, e, t, s, o = !1) {
  ...
  const c = t === void 0, d = c ? new _u() : null, h = [];
  for (let S = a; S <= l; S++) {
    const I = n.getCell(S, i), y = ku(I);
    h.push(y), d && d.update(y);
  }
  const g = c ? d.getDelimiter() : t, m = yu(g, o, s);
  let f = -1, C = 0, p = 0;
  const w = [];
  for (const S of h) {
    if (S !== void 0) {
...
var xu = /* @__PURE__ */ ((n) => (n.OthersCanView = "othersCanView", n.NoOneElseCanView = "noOneElseCanView", n))(xu || {}), $u = /* @__PURE__ */ ((n) => (n.DesignedUserCanEdit = "designedUserCanEdit", n.OnlyMe = "onlyMe", n))($u || {});
class me {
  constructor() {
    /**
...
var Lu = Object.getOwnPropertyDescriptor, Hu = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Lu(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Fu = (n, e) => (t, s) => e(t, s, n);
let z = class extends Lo {
  ...
  _ensureWorkbookSelection(e) {
    ...
    if (!t) {
      ...
      t = new Vu(s), this._workbookSelections.set(e, t);
    }
    return t;
  }
...
const Vh = "DISABLE_NORMAL_SELECTIONS", Lh = "SELECTIONS_ENABLED", Bu = "REF_SELECTIONS_ENABLED", Ls = {
...
var zu = Object.getOwnPropertyDescriptor, Gu = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? zu(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Ku = (n, e) => (t, s) => e(t, s, n);
const Ju = $s("sheets-formula.ref-selections.service");
...
function qu(n, e) {
  const s = n.get(Ho).getContextValue(Bu);
  return n.get(s && !e ? Ju : z);
}
const ie = {
  ...
  handler: (n, e) => {
    ...
    return qu(n).setSelections(o, r, [...t], s), !0;
  }
}, Yu = {
...
}, or = "sheet.command.move-range", bt = {
  type: v.COMMAND,
  id: or,
  // eslint-disable-next-line max-lines-per-function
  handler: async (n, e) => {
    var w, S;
    const t = n.get(E), s = n.get(V), o = n.get(M), r = n.get(Lt), i = n.get(it), a = n.get(G), u = P(o);
    ...
    const m = a.onCommandExecute({
      ...
      ...m.redos,
      {
        ...
        params: {
          unitId: h,
          subUnitId: d,
          selections: [{ range: e.toRange, primary: Xu(e.fromRange, e.toRange, c) }],
          type: we.MOVE_END
        }
      }
    ], C = [
...
function Fs(n, e, t, s = !1) {
  ...
  if (g && m && f && C) {
    ...
    X.foreach(l, (T, k) => {
      ...
      const D = Fo(T, k), H = N.getRelativeRange(D, i), F = N.getPositionRange(H, l), K = A.deepClone(I.getValue(T, k)), J = A.deepClone(w.getValue(T, k));
    ...
    o.push({ id: It.id, params: O }), r.push({ id: It.id, params: U });
  }
  return {
    redos: o,
    undos: r
...
const wn = {
  ...
  handler: (n, e) => {
    ...
    const { undos: O, redos: U } = i.onCommandExecute({
      id: wn.id,
      params: S
    ...
    if (t.push({ id: ee.id, params: m }, ...C.redos), s.push(...C.undos, {
      ...
      if (a === Re.COLUMNS && i.endColumn < g.endColumn) {
        ...
        for (let b = i.startRow; b <= S; b++) {
          const O = h.getRow(b), U = O ? jo(O) - 1 : 0;
          I = Math.max(I, U);
        }
        p = {
          startRow: i.startRow,
...
const Nr = "sheet.command.delete-range-move-left", vt = {
  type: v.COMMAND,
  id: Nr,
  handler: async (n, e) => {
    var I, y, b;
    ...
    if (p.push(...m.redos), p.push(ut(h, l, u)), w.push(...(b = m.preUndos) != null ? b : []), L(p, t).result) {
      ...
      return L(O.redos, t), w.push(...O.undos), p.push(...O.redos), s.pushUndoRedo({
        unitID: d,
...
}, Or = "sheet.command.delete-range-move-up", Mt = {
  type: v.COMMAND,
  id: Or,
  handler: async (n, e) => {
    var I, y, b;
  ...
  // all subsequent mutations should succeed inorder to make the whole process succeed
  // Promise.all([]).then(() => true),
}, ol = "sheet.command.insert-range-move-down", Nt = {
  type: v.COMMAND,
  id: "sheet.command.insert-range-move-down",
  // eslint-disable-next-line max-lines-per-function
  handler: async (n, e) => {
    var H, F, K;
    const t = n.get(E), s = n.get(V), o = n.get(M), r = n.get(z), i = n.get(G), a = n.get(Lt), u = n.get(it);
    if (r.isOverlapping())
  ...
  // all subsequent mutations should succeed inorder to make the whole process succeed
  // Promise.all([]).then(() => true),
}, Js = "sheet.command.insert-range-move-right", an = {
  type: v.COMMAND,
  id: Js,
  // eslint-disable-next-line max-lines-per-function
  handler: async (n, e) => {
  ...
  handler: async (n) => {
    ...
    const { worksheet: i, unitId: a, subUnitId: u } = r, l = s.endRow - s.startRow + 1, c = s.endRow + 1, d = s.endRow + l, h = 0, g = i.getColumnCount() - 1, m = {
      ...
      cellValue: pt(i, c, d, h, g, !0, s.endRow)
    };
  ...
  handler: async (n, e) => {
    ...
    const r = n.get(M), i = P(r);
    if (!i) return !1;
    const { worksheet: a, unitId: u, subUnitId: l } = i, c = e.value || 0, d = o.startRow, h = o.startRow + c - 1, g = 0, m = a.getColumnCount() - 1, f = pt(a, d, h, g, m, !0, d - 1), C = {
      unitId: u,
      subUnitId: l,
      direction: pe.UP,
      range: {
  ...
  handler: async (n, e) => {
    ...
    const { worksheet: a, unitId: u, subUnitId: l } = i, c = e.value || 0, d = o.endRow + 1, h = o.endRow + c, g = 0, m = a.getColumnCount() - 1, f = {
      ...
      // copy styles from the row below
      cellValue: pt(a, d, h, g, m, !0, o.endRow)
    };
    return n.get(E).executeCommand(Ye.id, f);
  }
  ...
  handler: (n, e) => {
    ...
    if (S.unshift(...(O = y.preRedos) != null ? O : []), S.push(...(U = y.redos) != null ? U : []), S.push(ut(i, g, m)), I.unshift(...(T = y.preUndos) != null ? T : []), I.push(...(k = y.undos) != null ? k : []), L(S, t).result) {
  ...
  handler: async (n) => {
    ...
    const { worksheet: i, unitId: a, subUnitId: u } = r, l = s.endColumn - s.startColumn + 1, c = s.endColumn + 1, d = s.endColumn + l, h = 0, g = i.getRowCount() - 1, m = {
      ...
      cellValue: pt(i, h, g, c, d, !1, s.endColumn)
    };
  ...
  handler: async (n, e) => {
    ...
    const { worksheet: a, unitId: u, subUnitId: l } = i, c = e.value || 0, d = o.endColumn + 1, h = o.endColumn + c, g = 0, m = a.getRowCount() - 1, f = {
      ...
      // copy styles from the column after
      cellValue: pt(a, g, m, d, h, !1, o.endColumn)
    };
    return n.get(E).executeCommand(Xe.id, f);
  }
}, $n = "sheet.command.remove-row", Wr = {
  type: v.COMMAND,
  ...
  handler: (n, e) => {
    ...
    c.forEach((S) => {
      ...
      y.push({ id: Te.id, params: b }), I.push({ id: ke.id, params: O }), I.push({ id: ee.id, params: T }), h.push(...y), d.unshift(...I);
    });
...
}, Wn = "sheet.command.remove-col", Vr = {
  type: v.COMMAND,
...
const Lr = "sheet.command.move-rows", un = {
  id: Lr,
  type: v.COMMAND,
  // eslint-disable-next-line max-lines-per-function
  handler: (n, e) => {
    ...
    if (!c) return !1;
    const { workbook: d, worksheet: h } = c, g = d.getUnitId(), m = h.getSheetId(), f = n.get(Lt), C = n.get(it), p = a[0].range, w = a[0].primary, S = cs(p, h, !1);
    if (!N.equals(p, S))
    ...
    const I = {
      ...
      sourceRange: p,
      targetRange: I
    }, b = La(n, y), O = n.get(E), U = u.onCommandExecute({ id: un.id, params: e }), T = [
      ...(H = U.preRedos) != null ? H : [],
      { id: Je.id, params: y }
    ], k = [
      ...(F = U.preUndos) != null ? F : [],
    ...
    if (T.push(...U.redos), k.push(...U.undos), L(T, O).result) {
      const K = u.afterCommandExecute({
        id: un.id,
        params: e
      });
      return L(K.redos, O), T.push(...K.redos), k.push(...K.undos), n.get(V).pushUndoRedo({
        unitID: g,
        undoMutations: k,
        redoMutations: T
      }), !0;
  ...
  handler: (n, e) => {
    ...
    const I = {
      ...
      sourceRange: p,
      targetRange: I
    }, b = Ha(n, y), O = n.get(E), U = u.onCommandExecute({ id: ln.id, params: e }), T = [
      ...(H = U.preRedos) != null ? H : [],
      { id: qe.id, params: y }
    ], k = [
      ...(F = U.preUndos) != null ? F : [],
...
var Rl = Object.getOwnPropertyDescriptor, Cl = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Rl(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, pl = (n, e) => (t, s) => e(t, s, n);
...
function In(n, e) {
  ...
  const t = e.worksheet.getColumnCount(), s = Math.ceil(Sl / t), o = [], r = [], i = e.getOffsetRelativeToRowCol(0, e.scrollY).row, a = n.map((l) => {
    let c;
...
const Br = "sheet.command.reorder-range", ks = {
  ...
  handler: (n, e) => {
    ...
    const { subUnitId: t, unitId: s, range: o, order: r } = e, i = n.get(E), a = {
      ...
      u,
      ...c.undos
    ], g = L(d, i), { suitableRanges: m, remainingRanges: f } = In([o], n.get(rt).getSkeleton(s, t)), { undos: C, redos: p } = l.generateMutationsOfAutoHeight({
      unitId: s,
      subUnitId: t,
      ranges: [o],
      autoHeightRanges: m,
...
const yn = Number.MAX_SAFE_INTEGER, Ke = (n) => {
  ...
  return (e.rangeType === j.COLUMN || t) && (e.startRow = 0, e.endRow = yn), (e.rangeType === j.ROW || s) && (e.startColumn = 0, e.endColumn = yn), e.rangeType === j.ALL && (e.startColumn = 0, e.endColumn = yn, e.startRow = 0, e.endRow = yn), e;
}, Oe = (n) => {
  let e = n.rangeType;
  ...
  if (!s || !t)
    return [];
  const o = Ke(t), r = Ke(s), i = Ke(e), a = Vn(
  ...
  if (!t || !s)
    return [];
  const o = [];
  if (N.contains(t, e) && o.push({
    type: Q.Delete
  }), N.contains(s, e)) {
    o.push({
      type: Q.Delete
    });
    const a = N.getRelativeRange(e, s), u = N.getPositionRange(a, t);
    return [
      {
        type: Q.Set,
        range: u
  ...
  if (!t || !s)
    return [e];
  if (!N.intersects(s, e) && !N.intersects(t, e))
    return [e];
  if (N.contains(s, e)) {
    const g = N.getRelativeRange(e, s);
  ...
  const r = new Y(), i = N.getIntersects(s, e);
  i && X.foreach(i, (g, m) => {
...
function kl(n, e, t) {
  const s = [];
  if (N.contains(e, t) && s.push({
    type: Q.Delete
  }), N.contains(n, t)) {
    s.push({
      type: Q.Delete
    });
    const o = N.getRelativeRange(t, n), r = N.getPositionRange(o, e);
    return [
      {
        type: Q.Set,
        range: r
...
const Ul = (n, e) => {
  ...
  if (!t)
    return [];
  const s = [], o = Dt(Oe(t), Oe(e)), { step: r, length: i } = o;
  return s.push({
    type: Q.VerticalMove,
    step: r,
    length: i
  ...
  if (!t)
    return [];
  const s = [], o = Dt(t, e), { step: r, length: i } = o;
  return s.push({
    type: Q.HorizontalMove,
    step: r,
    length: i
  ...
  }, r = N.subtract(e, o), i = N.getIntersects(o, e);
  if (!i)
    return [e];
  const a = new Y();
  return r.forEach((l) => {
  ...
  const s = {
    ...
    startColumn: t.startColumn,
    endColumn: Number.POSITIVE_INFINITY
  }, o = t.endColumn - t.startColumn + 1, r = N.getIntersects(t, e), i = N.subtract(e, s), a = N.getIntersects(s, e);
  if (!r && !a)
    return [e];
  const u = new Y();
  ...
  const s = {
    ...
    startRow: t.startRow,
    endRow: Number.POSITIVE_INFINITY
  }, o = t.endRow - t.startRow + 1, r = N.getIntersects(t, e), i = N.subtract(e, s), a = N.getIntersects(s, e);
  if (!r && !a)
    return [e];
  const u = new Y();
  return a && X.foreach(a, (c, d) => {
  ...
  return At(t, n);
}, Jh = (n, e, t) => [vt.id, Mt.id].includes(e.id) || Kr(e, t).some((r) => N.intersects(r, n)) ? po(n, e) : n, So = (n, e) => {
  let t = [];
  switch (e.id) {
    case W.DeleteRangeMoveLeftCommandId:
      return xl(e, n);
    ...
    case W.RemoveRowCommandId:
      return Vl(e.params, n);
  }
  const s = At(t, n);
  return s ? [s] : [];
}, qh = (n, e, t) => [vt.id, Mt.id, Nt.id, Js].includes(e.id) || Kr(e, t).some((r) => N.intersects(r, n)) ? So(n, e) : n;
function Fl(n, e) {
  ...
  switch (t) {
    ...
    case qe.id:
      ...
      break;
    case Me.id:
      o = Ot(s.range, n), o ? o.type = Q.HorizontalMove : o = { step: 0, length: 0, type: Q.Delete };
      break;
    case Te.id:
      o = Ot(Oe(s.range), Oe(n)), o ? o.type = Q.VerticalMove : o = { step: 0, length: 0, type: Q.Delete };
      break;
    case ke.id:
      o = Dt(Oe(s.range), Oe(n)), o.type = Q.VerticalMove;
      break;
    case Ue.id:
      o = Dt(s.range, n), o.type = Q.HorizontalMove;
      break;
    case It.id:
      {
  ...
  return o ? Array.isArray(o) ? At(o, n) : At([o], n) : n;
}
function Kr(n, e) {
  var s, o, r, i, a, u;
...
var jl = Object.getOwnPropertyDescriptor, zl = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? jl(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, bn = (n, e) => (t, s) => e(t, s, n);
const Gl = Rt("MERGE_REDO"), Kl = Rt("MERGE_UNDO"), wo = Math.floor(Number.MAX_SAFE_INTEGER / 10);
class Jl extends ue {
...
var Yl = Object.getOwnPropertyDescriptor, Xl = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Yl(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, yt = (n, e) => (t, s) => e(t, s, n);
const Zl = [Ue.id, ke.id, Me.id, Te.id], Ql = [Je.id, qe.id];
function Jr(n, e) {
  let t = n;
  if (e !== void 0) {
    const s = [];
...
const ec = Rt("mergeCellPermissionCheck");
let Ln = class extends ue {
  constructor(e, t, s, o, r, i) {
    super();
    R(this, "disposableCollection", new kt());
    R(this, "interceptor", new As({ MERGE_CELL_INTERCEPTOR_CHECK: ec }));
  ...
  _initCommandInterceptor() {
    ...
    this._sheetInterceptorService.interceptCommand({
      ...
      getMutations: ({ unitId: t, subUnitId: s, ranges: o }) => {
        ...
        if (!u)
          return a;
        const { worksheet: l } = u, d = l.getMergeData().filter((h) => o.some((g) => N.intersects(h, g)));
  ...
  _handleMoveRowsCommand(e, t, s) {
    ...
    if (i.forEach((m) => {
      if (c <= m.startRow && d >= m.endRow) {
        a.ranges.push(m);
        const f = jr({ id: W.MoveRowsCommandId, params: e }, m), C = At(f, m);
        C && u.ranges.push(C);
      }
    }), a.ranges.length === 0)
      return this._handleNull();
  ...
  _handleMoveColsCommand(e, t, s) {
    ...
    if (i.forEach((m) => {
      if (c <= m.startColumn && d >= m.endColumn) {
        a.ranges.push(m);
        const f = zr({ id: W.MoveColsCommandId, params: e }, m), C = At(f, m);
        C && u.ranges.push(C);
      }
    }), a.ranges.length === 0)
      return this._handleNull();
  ...
  _handleMoveRangeCommand(e, t, s) {
    ...
    if (!r)
      return this._handleNull();
    const i = r.getMergeData(), a = i.filter((g) => N.intersects(g, e.fromRange)), u = i.filter((g) => N.intersects(g, e.toRange)), l = a.map((g) => N.getRelativeRange(g, e.fromRange)).map((g) => N.getPositionRange(g, e.toRange)), c = Jr(l).filter(
  ...
  _handleRemoveColCommand(e, t, s) {
    ...
    if (!r)
      return this._handleNull();
    const { range: i } = e, { startColumn: a, endColumn: u } = i, l = A.deepClone(r.getMergeData()).reduce((S, I) => (N.intersects(i, I) && S.push(I), S), []);
    if (l.length === 0)
      return this._handleNull();
  ...
  _handleRemoveRowCommand(e, t, s) {
    ...
    if (!i)
      return this._handleNull();
    const { startRow: a, endRow: u } = o, l = A.deepClone(i.getMergeData()).reduce((S, I) => (N.intersects(o, I) && S.push(I), S), []);
    if (l.length === 0)
      return this._handleNull();
  ...
  _handleInsertRangeMoveDownCommand(e, t, s) {
    ...
    u.forEach((S) => {
      const { startRow: I, startColumn: y, endColumn: b, endRow: O } = i;
      if (N.intersects({ startRow: I, startColumn: y, endRow: a, endColumn: b }, S) && (l.push(S), N.contains({ startRow: I, startColumn: y, endRow: a, endColumn: b }, S))) {
        const k = O - I + 1;
        c.push({
  ...
  _handleDeleteRangeMoveUpCommand(e, t, s) {
    ...
    u.forEach((S) => {
      const { startRow: I, startColumn: y, endColumn: b, endRow: O } = i;
      if (N.intersects({ startRow: I, startColumn: y, endRow: a, endColumn: b }, S) && (l.push(S), N.contains({ startRow: I, startColumn: y, endRow: a, endColumn: b }, S))) {
        const k = O - I + 1, D = N.moveVertical(S, -k);
        c.push(D);
      }
    });
    const d = {
    ...
    this.disposeWithMe(this._commandService.onCommandExecuted((e) => {
      if (Ql.includes(e.id)) {
        ...
        c.forEach((f) => {
          ...
          N.intersects(f, o) || (i ? u < C && l > p ? (C -= a, p -= a) : u > p && l <= C && (C += a, p += a) : u < w && l > S ? (w -= a, S -= a) : u > S && l <= w && (w += a, S += a)), f.startRow === f.endRow && f.startColumn === f.endColumn || d.push({ startRow: C, endRow: p, startColumn: w, endColumn: S, rangeType: I });
...
const ms = {
  ...
  handler: (n, e) => {
    const t = n.get(E), s = n.get(V), o = n.get(M), r = e.unitId, i = e.subUnitId, a = e.selections, u = Jr(a, e.value), l = o.getUniverSheetInstance(r).getSheetBySheetId(i), c = [], d = [], h = tc(l, u), g = {
      unitId: r,
      subUnitId: i,
      ranges: u
    }, m = {
...
function eg(n, e, t, s, o) {
  const r = n.get(M), i = P(r, { unitId: e, subUnitId: t });
  if (!i) return;
  const { worksheet: a } = i;
  if (a.getMergeData().some((d) => s.some((h) => N.intersects(h, d))))
...
const _t = {
  ...
  async handler(n, e) {
    ...
    if (await t.executeCommand(_t.id, {
      ...
      const u = [{ id: _t.id, params: { unitId: r, rule: o, subUnitId: o.subUnitId } }], l = [{ id: $t.id, params: { unitId: r, subUnitId: i } }];
      s.pushUndoRedo({
        unitID: r,
        redoMutations: u,
        undoMutations: l
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(nn.id, e) ? (s.pushUndoRedo({
      unitID: o,
      undoMutations: [{ id: sn.id, params: r }],
      redoMutations: [{ id: nn.id, params: e }]
    }), !0) : !1;
  }
}, ac = "sheet.command.append-row", uc = {
  type: v.COMMAND,
  id: ac,
  handler: (n, e) => {
...
var lc = Object.getOwnPropertyDescriptor, cc = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? lc(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, bo = (n, e) => (t, s) => e(t, s, n);
...
function gc(n, e, t, s, o, r, i) {
  var b, O;
  const u = n.get(pn).getConfig(fs), l = {
    ...qr,
    ...u == null ? void 0 : u.largeSheetOperation
  }, c = Ni(t.getConfig());
  c.name = fc(e, r, c.name);
  const d = Ut();
  c.id = d;
  const h = e.getSheetIndex(t), { cellData: g } = c, f = dc(g) >= l.largeSheetCellCountThreshold;
  let C, p = [];
  if (f) {
    const { firstChunkCellData: U, remainingMutations: T } = hc(
      s,
      d,
      g,
      l.batchSize
...
const mc = {
  ...
  id: Zr,
  handler: (n, e) => {
    const t = n.get(E), s = n.get(V), o = n.get(M), r = n.get(G), i = n.get(it), a = n.get(Hn), u = P(o, e);
    if (!u)
      return !1;
    const { workbook: l, worksheet: c, unitId: d, subUnitId: h } = u, { redos: g, undos: m, newSheetId: f, isSplit: C, scheduledMutations: p } = gc(
      n,
      l,
      c,
      d,
...
const Rc = {
  ...
  handler(n, e) {
    ...
    const a = [{ id: $t.id, params: { unitId: r, subUnitId: i } }], u = [{ id: _t.id, params: { unitId: r, rule: o, subUnitId: i } }];
    return s.pushUndoRedo({
      unitID: r,
      redoMutations: a,
      undoMutations: u
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(sn.id, e) ? (s.pushUndoRedo({
      unitID: o,
      undoMutations: [{ id: nn.id, params: r }],
      redoMutations: [{ id: sn.id, params: e }]
    }), !0) : !1;
  }
}, Sc = {
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(tn.id, o) ? (s.pushUndoRedo({
      unitID: e.unitId,
      undoMutations: [{ id: On.id, params: o }],
      redoMutations: [{ id: tn.id, params: o }]
    }), !0) : !1;
  }
}, wc = {
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(cn.id, g) ? (s.pushUndoRedo({
      unitID: a,
  ...
  handler: (n, e) => {
    var b, O;
    const t = n.get(E), s = n.get(V), o = n.get(M), r = n.get(G), i = n.get(pn), a = P(o, e);
    if (!a) return !1;
    const { unitId: u, subUnitId: l, workbook: c, worksheet: d } = a;
    ...
    }, f = wl(d.getCellMatrix()) >= g.largeSheetCellCountThreshold, C = {
      subUnitId: l,
      unitId: u,
      subUnitName: d.getName()
    }, p = f ? null : gl(n, C), w = r.onCommandExecute({
      id: Zs.id,
      params: { unitId: u, subUnitId: l }
    }), S = [...(b = w.preRedos) != null ? b : [], { id: Ht.id, params: C }, ...w.redos], I = f ? [] : [...(O = w.preUndos) != null ? O : [], { id: cn.id, params: p }, ...w.undos];
...
const Qs = (n, e, t, s) => {
  ...
  e.startRow < 0 || e.startColumn < 0 || Fn(e, (i, a) => {
    var c, d;
...
function yc(n, e, t) {
  const { style: s, color: o, type: r } = n.getBorderInfo(), i = r === de.TOP || r === de.ALL || r === de.OUTSIDE, a = r === de.LEFT || r === de.ALL || r === de.OUTSIDE, u = r === de.BOTTOM || r === de.ALL || r === de.OUTSIDE, l = r === de.RIGHT || r === de.ALL || r === de.OUTSIDE, c = r === de.VERTICAL || r === de.ALL || r === de.INSIDE, d = r === de.HORIZONTAL || r === de.ALL || r === de.INSIDE, h = r.indexOf("tlbr") > -1, g = r.indexOf("tlbc") > -1, m = r.indexOf("tlmr") > -1, f = r.indexOf("bltr") > -1, C = r.indexOf("mltr") > -1, p = r.indexOf("bctr") > -1, w = t[0], {
    ...
    bottomRange: T,
    rightRange: k
  } = _c(w), D = new Y(), { worksheet: H, unitId: F, subUnitId: K } = e;
  return {
    worksheet: H,
    unitId: F,
    subUnitId: K,
...
const kc = (n) => {
  ...
  const { range: e, worksheet: t, mr: s, top: o, bottom: r, left: i, right: a, vertical: u, horizontal: l, tl_br: c, tl_bc: d, tl_mr: h, bl_tr: g, ml_tr: m, bc_tr: f, topRange: C, bottomRange: p, leftRange: w, rightRange: S, topRangeOut: I, bottomRangeOut: y, leftRangeOut: b, rightRangeOut: O } = n, U = (T, k, D) => {
    Qs(n, T, k, D);
  };
  !o && !r && !i && !a && !u && !l && !c && !d && !h && !g && !m && !f && (Fn(e, (T, k) => {
  ...
  }), U(I, { b: null }), U(C, { t: null }, !0), U(y, { t: null }), U(p, { b: null }, !0), U(b, { r: null }), U(w, { l: null }, !0), U(O, { l: null }), U(S, { r: null }, !0), U(e, { tl_br: null }, !0), U(e, { tl_bc: null }, !0), U(e, { tl_mr: null }, !0), U(e, { bl_tr: null }, !0), U(e, { ml_tr: null }, !0), U(e, { bc_tr: null }, !0));
}, vn = {
  id: "sheet.command.set-border",
  type: v.COMMAND,
  handler: (n, e) => {
    var p;
    const t = n.get(E), s = n.get(V), o = n.get(M), r = n.get(z), i = n.get(Ft), a = P(o, e);
    if (!a) return !1;
  ...
  handler: (n, e) => {
    if (!e.value) return !1;
    const t = n.get(E);
    return n.get(Ft).setType(e.value), t.syncExecuteCommand(vn.id);
  }
}, Pc = {
  ...
  handler: (n, e) => {
    const t = n.get(E);
    return n.get(Ft).setStyle(e.value), t.syncExecuteCommand(vn.id);
  }
}, Nc = {
  ...
  handler: (n, e) => {
    const t = n.get(E);
    return n.get(Ft).setColor(e.value), t.syncExecuteCommand(vn.id);
  }
}, Oc = {
  id: "sheet.command.set-border-basic",
  type: v.COMMAND,
  handler: (n, e) => {
    const { unitId: t, subUnitId: s, value: o, ranges: r } = e, { type: i, color: a, style: u } = o, l = n.get(E), c = n.get(Ft);
    return c.setType(i), a && c.setColor(a), c.setStyle(u), l.syncExecuteCommand(vn.id, {
      unitId: t,
      subUnitId: s,
      ranges: r
    });
...
const ni = {
  ...
  async handler(n, e) {
    ...
    return (i == null ? void 0 : i.unitType) === r.unitType ? r.unitType === x.Worksheet ? (l.push({ id: Et.id, params: { unitId: a, subUnitId: u, rule: r } }), c.push({ id: Et.id, params: { unitId: a, subUnitId: u, rule: i } })) : (l.push({ id: fe.id, params: { unitId: a, subUnitId: u, rule: r, ruleId: r.id } }), c.push({ id: fe.id, params: { unitId: a, subUnitId: u, ruleId: i.id, rule: i } })) : (i && (i.unitType === x.Worksheet ? (l.push({ id: $t.id, params: { unitId: a, subUnitId: u } }), c.push({ id: _t.id, params: { unitId: a, rule: i, subUnitId: i.subUnitId } })) : i.unitType === x.SelectRange && (l.push({ id: ot.id, params: { unitId: a, subUnitId: u, ruleIds: [i.id] } }), c.push({ id: Be.id, params: { unitId: a, subUnitId: u, rules: [i] } }))), r.unitType === x.Worksheet ? (l.push({ id: _t.id, params: { unitId: a, rule: r, subUnitId: r.subUnitId } }), c.unshift({ id: $t.id, params: { unitId: a, subUnitId: u } })) : r.unitType === x.SelectRange && (r.id = o.createRuleId(a, u), l.push({ id: Be.id, params: { unitId: a, subUnitId: u, rules: [r] } }), c.unshift({ id: ot.id, params: { unitId: a, subUnitId: u, ruleIds: [r.id] } }))), L(l, t) && s.pushUndoRedo({
      unitID: a,
      undoMutations: c,
      redoMutations: l
    }), !0;
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(Jt.id, c) ? (s.pushUndoRedo({
      unitID: a,
...
const jc = ["ff", "fs", "tr", "tb"], Ce = {
  ...
  handler: (n, e) => {
    ...
    let I = [], y = [];
    if (jc.includes(e == null ? void 0 : e.style.type)) {
      const { suitableRanges: k, remainingRanges: D } = In(h, C), H = qs(k, i), { undos: F, redos: K } = S.generateMutationsOfAutoHeight({
        unitId: o,
        subUnitId: r,
        ranges: k,
        autoHeightRanges: k,
    ...
    const { undos: b, redos: O } = S.onCommandExecute({
      id: Ce.id,
      params: e
    }), U = L([...O, ...y], l);
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(Tn.id, a) ? (s.pushUndoRedo({
      unitID: r,
      undoMutations: [{ id: Tn.id, params: u }],
      redoMutations: [{ id: Tn.id, params: a }]
    }), !0) : !1;
  }
}, ii = {
  ...
  handler: (n, e, t) => {
    ...
    return new Promise((a) => {
      setTimeout(() => {
        const u = s.syncExecuteCommand(Sn.id, {
          unitId: r,
          subUnitId: i
        }, t);
        a(u);
  ...
  handler: async (n, e) => {
    ...
    const w = n.get(rt).getSkeleton(u, l), { suitableRanges: S, remainingRanges: I } = In(p.ranges, w);
    qs(S, a);
    ...
    return T && K.result && r.pushUndoRedo({
      unitID: u,
      undoMutations: [{ id: ft.id, params: U }, ...b, ...H, ...k],
      redoMutations: [{ id: ft.id, params: p }, ...O, ...F, ...D]
    }), !0;
  }
}, jn = {
  type: v.COMMAND,
  ...
  handler: (n, e) => {
    ...
    const { subUnitId: u, unitId: l, worksheet: c } = a, d = n.get(rt).getSkeleton(l, u), h = {
      ...
      ranges: i,
      colWidth: e.value
    }, { suitableRanges: g, remainingRanges: m } = In(h.ranges, d);
    qs(g, c);
    const f = Zo(h, c), C = s.syncExecuteCommand(ft.id, h), { undos: p, redos: w } = r.generateMutationsOfAutoHeight({
      unitId: l,
      subUnitId: u,
      ranges: g,
      autoHeightRanges: g,
...
const nd = {
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(Yt.id, e) ? (s.pushUndoRedo({
      unitID: o,
  ...
  handler: (n, e) => {
    const t = n.get(E), s = n.get(V), o = n.get(Lt), r = n.get(it), i = P(n.get(M), e);
    if (!i) return !1;
    ...
    return a.getSheets().filter((p) => p.getConfig().hidden === te.FALSE).length === 1 ? (o.emit(r.t("sheets.info.hideSheet")), !1) : t.syncExecuteCommand(wt.id, h) ? (s.pushUndoRedo({
      unitID: l,
  ...
  handler: (n, e) => {
    ...
    return t.syncExecuteCommand(Pn.id, l) ? (s.pushUndoRedo({
      unitID: i,
...
const Ee = () => [Bs, Ve, hi, di], St = [_.Edit, _.View, _.ManageCollaborator, _.Delete], lg = (n = "unitId", e = "subUnitId", t = "permissionId") => Ee().reduce((s, o) => {
  const r = new o(n, e, t);
...
var ud = Object.getOwnPropertyDescriptor, ld = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? ud(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, ct = (n, e) => (t, s) => e(t, s, n);
const cd = "SHEET_WORKSHEET_PROTECTION_PLUGIN", dd = "SHEET_WORKSHEET_PROTECTION_POINT_PLUGIN";
let Gn = class extends Lo {
...
const to = {
  ...
  handler: (n, e) => {
    var S, I, y, b;
    const t = n.get(z), s = n.get(E), o = n.get(V), r = n.get(M), i = n.get(G), a = (S = e == null ? void 0 : e.ranges) != null && S.length ? e.ranges : (I = t.getCurrentSelections()) == null ? void 0 : I.map((O) => O.range);
    if (!(a != null && a.length))
      return !1;
    const u = P(r, e);
    if (!u) return !1;
    ...
    if (C.result && w.result) {
      ...
      return L(O.redos, s), o.pushUndoRedo({
        unitID: l,
        undoMutations: [
          ...(y = p.preRedos) != null ? y : [],
          {
  ...
  handler: (n, e) => {
    ...
    if (!i) return !1;
    const { unitId: a, subUnitId: u, worksheet: l } = i, c = (O = e == null ? void 0 : e.ranges) != null && O.length ? e.ranges : (U = o.getCurrentSelections()) == null ? void 0 : U.map((T) => T.range);
    if (!(c != null && c.length))
      return !1;
    const d = {
      unitId: a,
      ...
      Fe.id,
      d
    ), m = n.get(rt).getSkeleton(a, u), { suitableRanges: f, remainingRanges: C } = In(d.ranges, m), p = n.get(G), { undos: w, redos: S } = p.generateMutationsOfAutoHeight({
      unitId: a,
      subUnitId: u,
      ranges: f,
      autoHeightRanges: f,
  ...
  handler: (n, e) => {
    ...
    const d = {
      ...
      subUnitId: s,
      hidden: te.FALSE
    }, h = li(n, d), g = o.syncExecuteCommand(wt.id, d), m = {
      unitId: t,
      subUnitId: s
  ...
  handler: (n, e) => {
    ...
    if (!g) return !1;
    const { lastRow: m, rs: f, maxLength: C } = Uu(g, o, r, i, a), p = g.getColumnCount(), { startColumn: w } = X.transformRange(o, g);
  ...
  handler: (n, e) => {
    if (!e)
      return !1;
    const { styleJSON: t, unitId: s } = e, o = n.get(ve), r = new Ct(t.name);
  ...
  type: v.OPERATION,
  handler: () => !0
}, Wt = $s("INumfmtService"), dg = (n, e) => {
  const t = n.get(Wt), { values: s, unitId: o, subUnitId: r } = e, i = [], a = [];
  ...
  handler: (n, e) => {
    if (!e)
      return !1;
    const { values: t, refMap: s } = e, o = n.get(Wt), r = e.unitId, i = e.subUnitId, a = Object.keys(t).reduce(
      (u, l) => {
  ...
  handler: (n, e) => {
    ...
    return n.get(Wt).deleteValues(t, s, o), !0;
  }
}, hg = (n, e) => {
  const t = n.get(Wt), { ranges: s, unitId: o, subUnitId: r } = e, i = [];
  if (s.forEach((u) => {
    X.foreach(u, (l, c) => {
  ...
  return null;
}, Ed = "maxCellsPerSheet", kd = 3e6;
var Ud = Object.getOwnPropertyDescriptor, Td = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Ud(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Eo = (n, e) => (t, s) => e(t, s, n);
const Pd = "SHEET_DEFINED_NAME_PLUGIN", fg = "AllDefaultWorkbook";
...
var Nd = Object.getOwnPropertyDescriptor, Od = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Nd(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, vs = (n, e) => (t, s) => e(t, s, n);
const Dd = [
  ...
  _initOnlyLocalListener() {
    this._d.add(
      this._commandService.beforeCommandExecuted((e, t) => {
        Dd.includes(e.id) && (t || (t = {}), t.onlyLocal = !0);
      })
    ), this._d.add(
      this._commandService.onCommandExecuted((e, t) => {
        if (Ad.includes(e.id) && (t != null && t.fromCollab)) {
...
var xd = Object.getOwnPropertyDescriptor, $d = (n, e, t, s) => {
...
let Xn = class extends ue {
  ...
  _permissionCheckWithInsertRangeMove(e) {
    ...
    return !(!i || (e === "top" || e === "bottom" ? i.endRow = s.getRowCount() - 1 : (e === "left" || e === "right") && (i.endColumn = s.getColumnCount() - 1), this._rangeProtectionRuleModel.getSubunitRuleList(o, r).map((c) => c.ranges).flat().some((c) => N.getIntersects(i, c))));
  }
  ...
  permissionCheckWithoutRange(e) {
    ...
    return !(l && l.some((p) => {
      ...
      var b, O, U, T, k;
      const w = (O = (b = s.getCell(a, u)) == null ? void 0 : b.selectionProtection) == null ? void 0 : O[0];
      if (!(w != null && w.ruleId))
        return !1;
  ...
  permissionCheckWithRanges(e, t, s, o) {
    ...
    return l && h.push(...l.map((m) => new m(s).id)), c && h.push(...c.map((m) => new m(s, o).id)), d && this._rangeProtectionRuleModel.getSubunitRuleList(s, o).forEach((m) => {
      u.some((C) => m.ranges.some((p) => N.intersects(p, C))) && h.push(...d.map((C) => new C(s, o, m.permissionId).id));
  ...
  _permissionCheckByMoveCommand(e) {
    ...
    const a = this._rangeProtectionRuleModel.getSubunitRuleList(o, r).reduce((u, l) => [...u, ...l.ranges], []).filter((u) => N.intersects(u, i));
  ...
  _permissionCheckByMoveRangeCommand(e) {
    ...
    if (!t)
      return !1;
    const { worksheet: s, unitId: o, subUnitId: r } = t, i = e.toRange, a = this._rangeProtectionRuleModel.getSubunitRuleList(o, r).reduce((u, l) => [...u, ...l.ranges], []).filter((u) => N.intersects(u, i));
    return a.length > 0 ? !1 : (a.forEach((u) => {
      var l, c;
      for (let d = u.startRow; d <= u.endRow; d++)
        for (let h = u.startColumn; h <= u.endColumn; h++) {
  ...
  _permissionCheckWithFormula(e) {
      ...
      if (g) {
        ...
        for (let C = 0; C < f.length; C++) {
          ...
          if (w.sheetName) {
            ...
            if (!S)
              return !0;
            const { startRow: I, endRow: y, startColumn: b, endColumn: O } = w.range;
            for (let U = I; U <= y; U++)
              for (let T = b; T <= O; T++) {
        ...
        for (let f = 0; f < m.length; f++) {
          ...
          if (!I)
            return !0;
          const { startRow: b, endRow: O, startColumn: U, endColumn: T } = w.range;
          for (let k = b; k <= O; k++)
            for (let D = U; D <= T; D++) {
    ...
    if (s) {
      ...
      if (!c)
        return !1;
      const d = e.unitId || c.unitId, h = e.subUnitId || c.subUnitId, m = this._rangeProtectionRuleModel.getSubunitRuleList(d, h).filter((C) => C.ranges.some((p) => N.intersects(p, s))).map((C) => new Ve(d, h, C.permissionId).id);
...
var Wd = Object.getOwnPropertyDescriptor, Vd = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Wd(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Bt = (n, e) => (t, s) => e(t, s, n);
...
var Ld = Object.getOwnPropertyDescriptor, Hd = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? Ld(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Ge = (n, e) => (t, s) => e(t, s, n);
  ...
  _refreshPermissionByCollaCreate() {
    this.disposeWithMe(
      this._commandService.onCommandExecuted((n, e) => {
        if (e != null && e.fromCollab && (n.id === Be.id || n.id === _t.id || n.id === to.id)) {
          const t = n.params;
...
var jd = Object.getOwnPropertyDescriptor, zd = (n, e, t, s) => {
...
let es = class extends ue {
  ...
  constructor(n, e, t) {
    ...
    super(), this._commandService = n, this._configService = e, this._dataSyncPrimaryController = t, [
      ...
      yd,
      _d
    ].forEach((r) => this.disposeWithMe(this._commandService.registerCommand(r))), this._configService.setConfig(Ed, kd);
  }
};
es = qd([
  ys(0, E),
...
var Yd = Object.getOwnPropertyDescriptor, Xd = (n, e, t, s) => {
...
var th = Object.getOwnPropertyDescriptor, nh = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? th(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, En = (n, e) => (t, s) => e(t, s, n);
...
var oh = Object.getOwnPropertyDescriptor, rh = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? oh(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, bs = (n, e) => (t, s) => e(t, s, n);
let Ns = class extends ue {
...
var ih = Object.getOwnPropertyDescriptor, ah = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? ih(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, dt = (n, e) => (t, s) => e(t, s, n);
...
let os = class extends ue {
  ...
  _getRefRangeMutationsByDeleteCols(e, t, s) {
    const o = this._selectionProtectionRuleModel.getSubunitRuleList(t, s).filter((i) => i.ranges.some((a) => N.intersects(a, e.range))), r = e.range;
    if (o.length) {
      const i = [], a = [];
      return o.forEach((u) => {
      ...
      if (No.includes(e.id)) {
        ...
        this._selectionProtectionRuleModel.getSubunitRuleList(t.getUnitId(), s.getSheetId()).forEach((f) => {
          f.ranges.forEach((p) => {
            ...
            N.intersects(p, o) || (i ? u < w && l > S ? (w -= a, S -= a) : u > S && l <= w && (w += a, S += a) : u < I && l > y ? (I -= a, y -= a) : u > y && l <= I && (I += a, y += a)), this._checkIsRightRange({ startRow: w, endRow: S, startColumn: I, endColumn: y }) && (p.startColumn = I, p.endColumn = y, p.startRow = w, p.endRow = S);
          });
        }), this.disposableCollection.dispose();
...
var uh = Object.getOwnPropertyDescriptor, lh = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? uh(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, jt = (n, e) => (t, s) => e(t, s, n);
const ch = "SHEET_RANGE_PROTECTION_PLUGIN";
...
var dh = Object.getOwnPropertyDescriptor, hh = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? dh(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, gh = (n, e) => (t, s) => e(t, s, n);
let Os = class extends ue {
...
var mh = Object.defineProperty, fh = Object.getOwnPropertyDescriptor, Rh = (n, e, t) => e in n ? mh(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Ch = (n, e, t, s) => {
  for (var o = s > 1 ? void 0 : s ? fh(e, t) : e, r = n.length - 1, i; r >= 0; r--)
    (i = n[r]) && (o = i(o) || o);
  return o;
}, Oo = (n, e) => (t, s) => e(t, s, n), Ri = (n, e, t) => Rh(n, typeof e != "symbol" ? e + "" : e, t);
const ph = "SHEET_PLUGIN";
let is = class extends Gi {
  ...
  _initDependencies() {
    ...
    (e = this._config) != null && e.notExecuteFormula || n.push([ts]), Yi(this._injector, Xi(n, this._config.override)), _n(this._injector, [
      [G],
      [rs],
      [To],
      [Zn],
...
const Rg = {
   ...
   */
  WorksheetSetCellValuePermission: xn,
  /**
  ...
  if (!(a != null && a.value))
    return !1;
  const l = r.getSubunitRuleList(e, t).filter((c) => c.ranges.some((d) => s.some((h) => N.intersects(d, h))));
...
const Sh = (n, e, t, s, o = 1) => {
  ...
  if (!N.equals(s.range, l)) {
    const p = m ? u.range : Sh(s.range, t, l, e);
    if (!p)
      return null;
    const w = f ? kn(p.endRow, p.endColumn, t) : kn(p.startRow, p.startColumn, t);
    return {
      startRow: w.startRow,
      startColumn: w.startColumn,
      endRow: w.endRow,
  ...
  const C = f ? kn(u.range.endRow, u.range.endColumn, t) : kn(u.range.startRow, u.range.startColumn, t);
  return {
    startRow: C.startRow,
    startColumn: C.startColumn,
    endRow: C.endRow,
...
export {
  ...
  gg as AddMergeRedoSelectionsOperationFactory,
  We as AddMergeUndoMutationFactory,
  mg as AddMergeUndoSelectionsOperationFactory,
  Wu as AddRangeProtectionCommand,
  Be as AddRangeProtectionMutation,
  wd as AddRangeThemeMutation,
  Xh as AddWorksheetMergeAllCommand,
  ms as AddWorksheetMergeCommand,
  Qh as AddWorksheetMergeHorizontalCommand,
  ne as AddWorksheetMergeMutation,
  Zh as AddWorksheetMergeVerticalCommand,
  rc as AddWorksheetProtectionCommand,
  _t as AddWorksheetProtectionMutation,
  uc as AppendRowCommand,
  co as BEFORE_CELL_EDIT,
  Ft as BorderStyleManagerService,
  Eh as COMMAND_LISTENER_SKELETON_CHANGE,
  kh as COMMAND_LISTENER_VALUE_CHANGE,
  Wc as CancelFrozenCommand,
  ...
  mc as CopySheetCommand,
  Yr as CopyWorksheetEndMutation,
  Vh as DISABLE_NORMAL_SELECTIONS,
  qn as DefinedNameDataController,
  vt as DeleteRangeMoveLeftCommand,
  Mt as DeleteRangeMoveUpCommand,
  Rc as DeleteRangeProtectionCommand,
  ot as DeleteRangeProtectionMutation,
  Cc as DeleteWorksheetProtectionCommand,
  $t as DeleteWorksheetProtectionMutation,
  pc as DeleteWorksheetRangeThemeStyleCommand,
  sn as DeleteWorksheetRangeThemeStyleMutation,
  Va as DeleteWorksheetRangeThemeStyleMutationFactory,
  Bn as DeltaColumnWidthCommand,
  Kn as DeltaRowHeightCommand,
  $u as EditStateEnum,
  W as EffectRefRangId,
  Id as EmptyMutation,
  sh as ExclusiveRangeService,
  Wh as FactoryAddRangeProtectionMutation,
  $h as FactoryDeleteRangeProtectionMutation,
  tg as FactorySetRangeProtectionMutation,
  To as IExclusiveRangeService,
  ht as INTERCEPTOR_POINT,
  Wt as INumfmtService,
  Ju as IRefSelectionsService,
  cl as InsertColAfterCommand,
  ll as InsertColBeforeCommand,
  $r as InsertColByRangeCommand,
  Xe as InsertColCommand,
  Ue as InsertColMutation,
  us as InsertColMutationUndoFactory,
  Sc as InsertDefinedNameCommand,
  dl as InsertMultiColsLeftCommand,
  hl as InsertMultiColsRightCommand,
  al as InsertMultiRowsAboveCommand,
  ul as InsertMultiRowsAfterCommand,
  Nt as InsertRangeMoveDownCommand,
  an as InsertRangeMoveRightCommand,
  il as InsertRowAfterCommand,
  rl as InsertRowBeforeCommand,
  Ar as InsertRowByRangeCommand,
  Ye as InsertRowCommand,
  ke as InsertRowMutation,
  Ws as InsertRowMutationUndoFactory,
  wc as InsertSheetCommand,
  cn as InsertSheetMutation,
  Xr as InsertSheetUndoMutationFactory,
  Ca as InterceptCellContentPriority,
  Ed as MAX_CELL_PER_SHEET_KEY,
  ec as MERGE_CELL_INTERCEPTOR_CHECK,
  vd as MarkDirtyRowAutoHeightMutation,
  Ln as MergeCellController,
  ...
  Ns as NumfmtService,
  Q as OperatorType,
  Rg as PermissionPointsDefinitions,
  Bu as REF_SELECTIONS_ENABLED,
  Nh as RangeMergeUtil,
  ...
  _d as RemoveRangeThemeMutation,
  ...
  gl as RemoveSheetUndoMutationFactory,
  vc as RemoveWorksheetMergeCommand,
  se as RemoveWorksheetMergeMutation,
  ks as ReorderRangeCommand,
  Dn as ReorderRangeMutation,
  ja as ReorderRangeUndoMutationFactory,
  Jc as ResetBackgroundColorCommand,
  Gc as ResetTextColorCommand,
  fg as SCOPE_WORKBOOK_VALUE_DEFINED_NAME,
  Lh as SELECTIONS_ENABLED,
  Dh as SELECTION_CONTROL_BORDER_BUFFER_COLOR,
  Oh as SELECTION_CONTROL_BORDER_BUFFER_WIDTH,
  fs as SHEETS_PLUGIN_CONFIG_KEY,
  bd as ScrollToCellOperation,
  Yu as SelectRangeCommand,
  we as SelectionMoveType,
  Kc as SetBackgroundColorCommand,
  ng as SetBoldCommand,
  Oc as SetBorderBasicCommand,
  Nc as SetBorderColorCommand,
  vn as SetBorderCommand,
  Tc as SetBorderPositionCommand,
  Pc as SetBorderStyleCommand,
  Dc as SetColDataCommand,
  ...
  jn as SetColWidthCommand,
  ni as SetDefinedNameCommand,
  ag as SetFontFamilyCommand,
  ug as SetFontSizeCommand,
  $c as SetFrozenCommand,
  st as SetFrozenMutation,
  si as SetFrozenMutationFactory,
  Vc as SetGridlinesColorCommand,
  Kt as SetGridlinesColorMutation,
  Yc as SetHorizontalTextAlignCommand,
  sg as SetItalicCommand,
  so as SetNumfmtMutation,
  ig as SetOverlineCommand,
  Lc as SetProtectionCommand,
  fe as SetRangeProtectionMutation,
  yd as SetRangeThemeMutation,
  wn as SetRangeValuesCommand,
  ee as SetRangeValuesMutation,
  Ae as SetRangeValuesUndoMutationFactory,
  Hc as SetRowDataCommand,
  Jt as SetRowDataMutation,
  ru as SetRowDataMutationFactory,
  Jn as SetRowHeightCommand,
  ...
  Hn as SheetLazyExecuteScheduleService,
  Xn as SheetPermissionCheckController,
  Zn as SheetPermissionInitController,
  ...
  Yn as SheetsFreezeSyncController,
  z as SheetsSelectionsService,
  Mu as SplitDelimiterEnum,
  Rd as SplitTextToColumnsCommand,
  Cd as ToggleCellCheckboxCommand,
  pd as ToggleGridlinesCommand,
  Zt as ToggleGridlinesMutation,
  _ as UnitAction,
  x as UnitObject,
  is as UniverSheetsPlugin,
  Sd as UnregisterWorksheetRangeThemeStyleCommand,
  Xs as UnregisterWorksheetRangeThemeStyleMutation,
  ps as VALIDATE_CELL,
  xu as ViewStateEnum,
  rr as WorkbookCommentPermission,
  ir as WorkbookCopyPermission,
  Zu as WorkbookCopySheetPermission,
  ar as WorkbookCreateProtectPermission,
  ur as WorkbookCreateSheetPermission,
  Qu as WorkbookDeleteColumnPermission,
  el as WorkbookDeleteRowPermission,
  ...
  tl as WorkbookHistoryPermission,
  nl as WorkbookInsertColumnPermission,
  sl as WorkbookInsertRowPermission,
  ...
  Gn as WorksheetPermissionService,
  Er as WorksheetPivotTablePermission,
  Mn as WorksheetProtectionPointModel,
  lt as WorksheetProtectionRuleModel,
  jh as WorksheetSelectProtectedCellsPermission,
  zh as WorksheetSelectUnProtectedCellsPermission,
  kr as WorksheetSetCellStylePermission,
  xn as WorksheetSetCellValuePermission,
  ...
  Qn as ZebraCrossingCacheController,
  eg as addMergeCellsUtil,
  Fl as adjustRangeOnMutation,
  cs as alignToMergedCellsBorders,
  St as baseProtectionActions,
  uo as checkCellValueType,
  Cg as checkRangesEditablePermission,
  vu as convertPrimaryWithCoordToPrimary,
  Ah as convertSelectionDataToRange,
  pt as copyRangeStyles,
  wl as countCells,
  wu as createTopMatrixFromMatrix,
  Su as createTopMatrixFromRanges,
  qr as defaultLargeSheetOperationConfig,
  ad as defaultWorkbookPermissionPoints,
  ws as defaultWorksheetPermissionPoint,
  Ph as expandToContinuousRange,
  hg as factoryRemoveNumfmtUndoMutation,
  dg as factorySetNumfmtUndoMutation,
  tr as findAllRectangle,
  xh as findFirstNonEmptyCell,
  ut as followSelectionOperation,
  sr as generateNullCell,
  Ou as generateNullCellValue,
  ...
  Hh as getCellAtRowCol,
  lg as getDefaultRangePermission,
  Tr as getInsertRangeMutations,
  Fs as getMoveRangeUndoRedoMutations,
  pg as getNextPrimaryCell,
  _e as getPrimaryForRange,
  Pr as getRemoveRangeMutations,
  qu as getSelectionsService,
  Yh as getSeparateEffectedRangesOnCommand,
  P as getSheetCommandTarget,
  Yo as getSheetCommandTargetWorkbook,
  Qe as getSheetMutationTarget,
  Th as getSkeletonChangedEffectedRange,
  Uh as getValueChangedEffectedRange,
  ls as getVisibleRanges,
  Dt as handleBaseInsertRange,
  Vn as handleBaseMoveRowsCols,
  Ot as handleBaseRemoveRange,
  So as handleCommonDefaultRangeChangeWithEffectRefCommands,
  qh as handleCommonRangeChangeWithEffectRefCommandsSkipNoInterests,
  po as handleDefaultRangeChangeWithEffectRefCommands,
  Jh as handleDefaultRangeChangeWithEffectRefCommandsSkipNoInterests,
  Al as handleDeleteRangeMoveLeft,
  $l as handleDeleteRangeMoveUp,
  Kh as handleDeleteRangeMutation,
  Gr as handleIRemoveCol,
  bl as handleIRemoveRow,
  Tl as handleInsertCol,
  Pl as handleInsertRangeMoveDown,
  Ol as handleInsertRangeMoveRight,
  Gh as handleInsertRangeMutation,
  Ul as handleInsertRow,
  zr as handleMoveCols,
  _l as handleMoveRange,
  jr as handleMoveRows,
  Bh as isSingleCellSelection,
  nr as rangeMerge,
  Au as rangeToDiscreteRange,
  Oe as rotateRange,
  At as runRefRangeMutations,
  Fh as setEndForRange,
  Uu as splitRangeText,
