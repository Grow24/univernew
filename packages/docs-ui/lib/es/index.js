...
import { IUniverInstanceService as L, Inject as j, Disposable as me, toDisposable as Mn, UniverInstanceType as _, BuildTextUtils as ce, JSONX as W, ObjectRelativeFromV as gt, ObjectRelativeFromH as Co, CommandType as D, sequenceExecuteAsync as Pr, ICommandService as T, DataStreamTreeTokenType as V, TextX as Ie, TextXActionType as G, PresetListType as xe, UpdateDocsAttributeType as nn, Tools as ue, generateRandomId as ge, TableRowHeightRule as Dc, TableSizeType as Yi, TableTextWrapType as wc, TableAlignmentType as Pc, MemoryCursor as Nt, SHEET_EDITOR_UNITS as En, PositionedObjectLayoutType as Ro, BlockType as Nc, LRUMap as Lc, BaselineOffset as Ve, BooleanNumber as z, ColorKit as Qs, DrawingTypeEnum as Nr, skipParseTagNames as Qc, CustomRangeType as Lr, DataStreamTreeNodeType as sn, createIdentifier as Ki, ILogService as Qr, SliceBodyType as ir, DOCS_NORMAL_EDITOR_UNIT_ID_KEY as bo, DOC_RANGE_TYPE as He, normalizeBody as Uc, getBodySlice as qi, FOCUSING_DOC as _n, EDITOR_ACTIVATED as eo, DashStyleType as Fc, RxDisposable as Ct, ThemeService as Ur, IUndoRedoService as xo, PRESET_LIST_TYPE as Hc, HorizontalAlign as Ue, NamedStyleType as K, RANGE_DIRECTION as De, COLORS as gn, Rectangle as kc, DocumentFlavor as Pe, LocaleService as Ye, isInternalEditorID as Rt, IContextService as Fr, Injector as Dn, FOCUSING_EDITOR_STANDALONE as Us, FOCUSING_COMMENT_EDITOR as Fs, isCommentEditorID as Vc, VerticalAlign as Wc, DEFAULT_EMPTY_DOCUMENT_VALUE as Xi, PageOrientType as jc, PAPER_TYPES as zc, PAGE_SIZE as ar, DOCS_ZEN_EDITOR_UNIT_ID_KEY as nt, DEFAULT_STYLES as yo, NAMED_STYLE_MAP as Gc, DisposableCollection as In, fromEventSubject as Mt, deepCompare as Yc, FOCUSING_UNIVER_EDITOR as Hr, FOCUSING_COMMON_DRAWINGS as Zi, getPlainText as to, debounce as kr, SpacingRule as Xt, IConfigService as Vr, QuickListTypeMap as jo, Direction as le, DOCS_FORMULA_BAR_EDITOR_UNIT_ID_KEY as Kc, checkForSubstrings as qc, createInterceptorKey as Ji, InterceptorManager as Xc, UndoCommandId as Hs, RedoCommandId as ks, DependentOn as Zc, Plugin as Jc, merge as $c, touchDependencies as Vs, mergeOverrideWithDependencies as el, createInternalEditorID as tl } from "@univerjs/core";
import { DocSelectionManagerService as Y, RichTextEditingMutation as X, DocSkeletonManagerService as de, SetTextSelectionsOperation as Le, DocStateEmitService as nl, DocInterceptorService as ol } from "@univerjs/docs";
import { IRenderManagerService as pe, DocumentEditArea as ve, hasListGlyph as rl, isIndentByGlyph as sl, isFirstGlyph as il, getParagraphByGlyph as al, pixelToPt as cl, ptToPixel as Ws, parseDataStreamToTree as ll, Liquid as $i, GlyphType as ea, DocumentSkeletonPageType as Oe, getPageFromPath as cr, getTableIdAndSliceIndex as js, NORMAL_TEXT_SELECTION_PLUGIN_STYLE as Sn, getColor as fn, RegularPolygon as ta, Rect as Kn, getOffsetRectForDom as dl, ScrollTimer as Al, CURSOR_TYPE as Dt, getSystemHighlightColor as ul, Vector2 as vn, PageLayoutType as Cn, Shape as hl, Path as zs, pxToNum as na, TRANSFORM_CHANGE_OBSERVABLE_TYPE as oa, getNumberUnitValue as on, Viewport as gl, ScrollBar as lr, Layer as Gs, Documents as fl, DocBackground as pl, getLastLine as ml, lineIterator as El, getLastColumn as Il, UniverRenderEnginePlugin as Sl, DeviceInputEventType as ra } from "@univerjs/engine-render";
import { IClipboardInterfaceService as sa, FILE_PNG_CLIPBOARD_MIME_TYPE as vl, FILE__WEBP_CLIPBOARD_MIME_TYPE as Cl, FILE__JPEG_CLIPBOARD_MIME_TYPE as Rl, FILE__BMP_CLIPBOARD_MIME_TYPE as bl, HTML_CLIPBOARD_MIME_TYPE as ia, PLAIN_TEXT_CLIPBOARD_MIME_TYPE as aa, CopyCommand as xl, CutCommand as yl, PasteCommand as Ol, ILayoutService as Oo, KeyCode as q, IConfirmService as ca, useDependency as J, ComponentManager as rn, ISidebarService as la, getMenuHiddenObservable as se, MenuItemType as Z, COLOR_PICKER_COMPONENT as da, FONT_FAMILY_ITEM_COMPONENT as Tl, FONT_FAMILY_COMPONENT as Bl, FONT_SIZE_LIST as Ml, FONT_SIZE_COMPONENT as _l, HEADING_LIST as Ys, COMMON_LABEL_COMPONENT as Dl, HEADING_ITEM_COMPONENT as wl, ICanvasPopupService as Pl, IMenuManagerService as Aa, ToolbarItem as Nl, MenuManagerPosition as Ll, useObservable as et, RectPopup as Ql, DesktopMenu as Ul, ContextMenuPosition as no, MetaKeys as te, Slider as Fl, useConfigValue as ua, useEvent as mn, ContextMenuGroup as an, RibbonInsertGroup as Hl, RibbonStartGroup as Ks, IUIPartsService as kl, IShortcutService as To, BuiltInUIPart as qs, connectInjector as Xs, imageMimeTypeSet as Vl, IContextMenuService as Wl } from "@univerjs/ui";
import { ImageSourceType as Wr } from "@univerjs/drawing";
import { Subject as be, BehaviorSubject as Fe, merge as ha, filter as oo, takeUntil as ft, fromEvent as je, Observable as fe, map as wn, combineLatest as Pn, distinctUntilChanged as Wt, throttleTime as Rn, switchMap as jl, take as zl, first as Gl, of as Yl, animationFrameScheduler as Kl } from "rxjs";
import { useRef as ke, createElement as Te, forwardRef as Be, useState as Ee, useEffect as Ce, useMemo as _e, useCallback as ga, useImperativeHandle as ql, useLayoutEffect as fa } from "react";
import { filter as dr, bufferTime as Xl, map as Zl } from "rxjs/operators";
import { jsxs as re, jsx as Q, Fragment as Jl } from "react/jsx-runtime";
import { Checkbox as Zs, InputNumber as it, Button as $l, clsx as ze, borderClassName as Nn, Select as pa, scrollbarClassName as ed, Tooltip as td } from "@univerjs/design";
...
const ad = 0, zo = 2, cd = 4, $s = 10, Gf = "normalTextSelectionPluginName";
function pt(n) {
...
const Gr = {
  ...
  handler: (n, e) => {
    ...
    if (A == null)
      return !1;
    const { collapsed: x } = i, C = E.dataStream.length, B = [
      {
        startOffset: u + C,
        endOffset: u + C,
    ...
    ((($ = p.bullet) == null ? void 0 : $.listType) === xe.CHECK_LIST_CHECKED || (U = p.paragraphStyle) != null && U.headingId) && (i.endOffset < I && M.push({
      t: G.RETAIN,
      len: I - i.endOffset
    }), M.push({
      t: G.RETAIN,
      ...
      if (v) {
        ...
        for (const R of v.children) {
          ...
          for (const b of R.children) {
            const x = R.children.indexOf(b);
            t >= b.startIndex && t <= b.endIndex && (l = E, A = x), o >= b.startIndex && o <= b.endIndex && (h = x);
          }
        }
      }
      if (c)
...
const Od = En, va = {
  ...
  handler: async (n, e) => {
    ...
    for (let P = 0; P < c.length; P++) {
      ...
      const ne = jr((w = g.customRanges) != null ? w : [], $, Od.includes(f)), ie = zr((F = g.customDecorations) != null ? F : [], $);
...
function Bd(n, e, t) {
  ...
  const l = xd(o, n), A = (g = e.getDrawings()) != null ? g : {}, h = (f = e.getDrawingsOrder()) != null ? f : [], u = l.sort((p, m) => h.indexOf(p) > h.indexOf(m) ? -1 : h.indexOf(p) < h.indexOf(m) ? 1 : 0);
  if (u.length > 0)
    for (const p of u) {
...
function Md(n, e, t, o) {
  ...
  for (const l of n) {
    ...
    if (!(A == null || h == null))
      if (g) {
        const f = Sa({ startOffset: A, endOffset: h, segmentId: o }, t);
        if (f == null)
          continue;
...
function _d(n, e, t, o, r) {
  let s = [];
  if (Array.isArray(n) && (n == null ? void 0 : n.length) !== 0 && (s = Bd(n, t, r)), Array.isArray(e) && (e == null ? void 0 : e.length) !== 0) {
    const i = Md(e, t, o, r);
...
const $t = {
  ...
  handler: (n, e) => {
    ...
    return u.params.actions = _d(a, c, l, h, s), !!o.syncExecuteCommand(u.id, u.params);
  }
};
var Ne = /* @__PURE__ */ ((n) => (n[n.LEFT = 0] = "LEFT", n[n.RIGHT = 1] = "RIGHT", n))(Ne || {});
const Dd = "doc.command.insert-text", Ca = {
  id: Dd,
  type: D.COMMAND,
  handler: async (n, e) => {
    var E;
...
const Zr = {
  ...
  handler: async (n, e) => {
    ...
    }, x = new Ie(), C = W.getInstance();
    S.startIndex > 0 && x.push({
      t: G.RETAIN,
      len: S.startIndex
    }), x.push({
      t: G.DELETE,
      len: 1
    }), v.startIndex > S.startIndex + 1 && x.push({
      t: G.RETAIN,
      len: v.startIndex - S.startIndex - 1
    });
    const B = Object.values(V), y = u[S.startIndex - 1];
    (y && !B.includes(y) || y === " ") && x.push({
      t: G.RETAIN,
      len: 1,
      coverType: nn.REPLACE,
      body: {
    ...
    const M = Ae(A, d);
    return b.params.actions = C.editOp(x.serialize(), M), !!r.syncExecuteCommand(b.id, b.params);
  }
}, ba = {
...
const Do = {
  ...
  handler: async (n) => {
    ...
    if (f == null)
      return !1;
    const p = c, { startOffset: m, collapsed: I } = p, S = A.findNodeByCharIndex(m, h, g), v = rl(S), R = sl(S, f);
    let E = m;
    const b = A.findNodeByCharIndex(m - 1, h, g);
    if (il(S) && b !== S && (v === !0 || R === !0) && I) {
      const P = al(S, f);
      if (P == null)
        return !1;
      ...
      if (b.content === "\r") {
        ...
        if (P.layoutType === Ro.INLINE || (N == null ? void 0 : N.blockType) === Nc.CUSTOM) {
          const $ = s.getUnitId();
          ...
          r = await o.executeCommand(xn.id, {
            unitId: s.getUnitId(),
            range: {
              ...c,
    ...
    if (m === !0) {
      ...
      if (R.content === "\r")
        ...
        if (b.layoutType === Ro.INLINE) {
          ...
          I = await s.executeCommand(xn.id, {
            unitId: o.getUnitId(),
            range: {
              ...i,
              startOffset: f + 1,
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    switch (s) {
      ...
      case "font-size": {
        ...
        Number.isNaN(a) || (i.endsWith("pt") ? t.fs = a : i.endsWith("px") && (t.fs = cl(a)));
        break;
      }
      case "font-style": {
...
const ni = 660, vo = class vo {
  ...
  convert(e, t = {}) {
    var a;
    const o = vo._pluginList.find((c) => c.checkPasteType(e)), r = Ud(e), i = {
      body: {
        dataStream: "",
        paragraphs: [],
        sectionBreaks: [],
    ...
    for (const d of t)
      if (d.nodeType === Node.TEXT_NODE) {
        ...
        if (d.nodeType === Node.ELEMENT_NODE) {
          const l = d, A = this._processBeforeLink(l, o), h = e ? this._styleCache.get(e) : {}, u = this._styleRules.find(({ filter: m }) => ti(d, m)), g = u ? u.getStyle(d) : ts(d);
  ...
  _processAfterTable(e, t) {
    ...
    switch (o) {
      case "TABLE": {
        const c = this._tableCache.pop(), { startIndex: d, table: l } = c, A = l.tableRows[0].tableCells.length, h = Xr(ni / A), u = [...new Array(A).fill(null).map(() => ue.deepClone(h))];
...
`, t.push({
  ...
  const s = { html: "" }, i = ll(r).sectionList;
  for (const a of i)
    Kt(a, n, s);
  return s.html;
}
...
var Gd = Object.getOwnPropertyDescriptor, Yd = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Gd(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, cn = (n, e) => (t, o) => e(t, o, n);
en.use(kd);
...
let ur = class extends me {
  ...
  async _setClipboardData(e, t = !0) {
    var i, a, c, d;
    const o = Nd(), r = (e.length > 1 ? e.map((l) => {
      var A;
...
const Ba = {
  ...
  handler: async (n, e) => {
    ...
    const { startOffset: I, endOffset: S } = u, v = o.length, R = [
      ...
      x,
      En.includes(t)
    ), y = zr(($ = p.customDecorations) != null ? $ : [], I + r), M = new Ie(), w = W.getInstance();
    if (!u.collapsed && i) {
...
const si = "doc.command.set-inline-format-bold", Qt = {
...
}, ui = "doc.command.set-inline-format-font-family", _t = {
  id: ui,
  type: D.COMMAND,
  handler: async (n, e) => {
    const t = n.get(T);
...
}, hi = "doc.command.set-inline-format-text-color", mt = {
  id: hi,
  type: D.COMMAND,
  handler: async (n, e) => {
    const t = n.get(T);
...
}, gi = "doc.command.set-inline-format-text-background-color", Et = {
  id: gi,
  type: D.COMMAND,
  handler: async (n, e) => {
    const t = n.get(T);
...
}, fi = "doc.command.reset-inline-format-text-background-color", Un = {
  id: fi,
  type: D.COMMAND,
  handler: async (n, e) => {
    const t = n.get(T);
  ...
  handler: async (n, e) => {
    ...
    I.reset();
    for (const E of c) {
      let { startOffset: b, endOffset: x, rangeType: C } = E;
      if (b == null || x == null)
        continue;
...
function Ma(n, e, t) {
  ...
  if (/ul|st/.test(e))
    return Kd(n == null ? void 0 : n[e]) && (n == null ? void 0 : n[e]).s === z.TRUE ? {
      s: z.FALSE
    } : {
      s: z.TRUE
    };
...
function _a(n, e, t) {
  ...
  const { textRuns: i = [] } = qi(n, o, r), a = ue.deepClone(t), c = i.map((x) => {
    var C;
    return (C = x == null ? void 0 : x.ts) == null ? void 0 : C.fs;
  }).filter(Boolean);
  a.fs = a.fs ? Math.max(a.fs, ...c) : c.length ? Math.max(...c) : void 0, a.fs = !a.fs || Number.isNaN(a.fs) ? void 0 : a.fs, a.ff = (u = (h = (A = i.find((x) => {
    var C;
  ...
  })) == null ? void 0 : p.ts) == null ? void 0 : m.bg) != null ? I : a.bg, a.cl = (R = (v = (S = i.find((x) => {
    var C;
    return ((C = x.ts) == null ? void 0 : C.cl) != null;
  })) == null ? void 0 : S.ts) == null ? void 0 : v.cl) != null ? R : a.cl;
  const d = i.filter((x) => {
    var C;
    return ((C = x == null ? void 0 : x.ts) == null ? void 0 : C.va) != null;
  });
  if (d.length > 0 && d.length === i.length) {
    const x = (E = d[0].ts) == null ? void 0 : E.va;
    let C = !0;
    for (let B = 1; B < d.length; B++)
      if (((b = d[B].ts) == null ? void 0 : b.va) !== x) {
        C = !1;
        break;
      }
    C && (a.va = x);
...
const Pa = {
  ...
  handler: (n, e) => {
    ...
    if (i == null || a.length === 0)
      return !1;
    const c = a[0].segmentId, d = i.getSelfOrHeaderFooterModel(c), l = (b = (E = d.getBody()) == null ? void 0 : E.paragraphs) != null ? b : [], A = (C = (x = d.getBody()) == null ? void 0 : x.dataStream) != null ? C : "";
    if (!l.length)
      return !1;
...
const gr = {
  ...
  handler: (n, e) => {
    ...
    if (i == null || a == null)
      return !1;
    const { segmentId: c } = a, d = (v = o.getDocRanges()) != null ? v : [], l = i.getSelfOrHeaderFooterModel(c), A = (E = (R = l.getBody()) == null ? void 0 : R.paragraphs) != null ? E : [], h = (x = (b = l.getBody()) == null ? void 0 : b.dataStream) != null ? x : "";
    if (!A.length)
      return !1;
  ...
  handler(n, e) {
    ...
    let S = ge(6);
    const v = (M = (y = s.getBody()) == null ? void 0 : y.paragraphs) != null ? M : [], R = v.findIndex((F) => F.startIndex === l.startIndex), E = v[R - 1], b = v[R + 1];
    ...
    const C = Ae(s, a);
    return x.params.actions = g.editOp(u.serialize(), C), !!r.syncExecuteCommand(x.id, x.params);
  }
};
function cs(n, e) {
  var l, A;
...
const ls = {
  ...
  type: D.COMMAND,
  handler: (n) => cs(n, xe.BULLET_LIST)
}, ds = {
  id: "doc.command.insert-order-list-bellow",
  type: D.COMMAND,
  handler: (n) => cs(n, xe.ORDER_LIST)
}, As = {
  id: "doc.command.insert-check-list-bellow",
  type: D.COMMAND,
  handler: (n) => cs(n, xe.CHECK_LIST)
}, lt = {
  ...
  handler: (n, e) => {
    ...
    if (a.length === 0)
      return !1;
    const c = a[0].segmentId, d = i.getSelfOrHeaderFooterModel(c), l = (E = (R = d.getBody()) == null ? void 0 : R.paragraphs) != null ? E : [], A = (x = (b = d.getBody()) == null ? void 0 : b.dataStream) != null ? x : "";
    if (l == null)
      return !1;
  ...
  handler(n, e) {
    ...
    if (i == null || a == null || !a.collapsed)
      return !1;
    const { segmentId: c, startOffset: d } = a, l = i.getSelfOrHeaderFooterModel(c), A = (E = (R = l.getBody()) == null ? void 0 : R.paragraphs) != null ? E : [], h = (x = (b = l.getBody()) == null ? void 0 : b.dataStream) != null ? x : "", u = ce.paragraph.util.getParagraphsInRange(a, A, h)[0];
    if (!u)
      return !1;
...
class It {
  ...
  getRangePointData(e, t) {
    ...
    return this._selectionIterator(a, c, (d, l, A, h, u, g) => {
      ...
      let x, C;
      const B = v[d], y = v[l], M = v[d - 1], w = (B == null ? void 0 : B.left) || 0, F = (B == null ? void 0 : B.width) || 0, P = (y == null ? void 0 : y.left) || 0, N = (y == null ? void 0 : y.width) || 0, ee = (B == null ? void 0 : B.glyphType) === ea.LIST, { startOffset: $, endOffset: U } = nA(v, d, l, R), H = a.glyph === d && A ? a.isBack : !0, k = c.glyph === l && h ? c.isBack : !1, ne = a === c, ie = H && M != null ? M : B;
      if (d === 0 && l === v.length - 1)
        x = {
          startX: E + w + (ee ? F : 0),
          startY: b,
      ...
      o.push(pr(x)), r.push(pr(C)), s.push({
        startOffset: H ? $ : $ + B.count,
        endOffset: k ? U : U + y.count,
        collapsed: ne
      });
    }), {
      borderBoxPointGroup: o,
  ...
  _selectionIterator(e, t, o) {
    ...
    for (let E = I; E <= S; E++) {
      const b = c[E], { headerId: x, footerId: C, pageWidth: B } = b;
      let y = b;
      if (s === Oe.HEADER ? y = (v = d.get(x)) == null ? void 0 : v.get(B) : s === Oe.FOOTER ? y = (R = l.get(C)) == null ? void 0 : R.get(B) : s === Oe.CELL && (y = cr(a, i)), y == null) {
        this._liquid.translatePage(b, f, p, m);
        continue;
      }
        ...
        for (let H = $; H <= U; H++) {
          ...
          for (let oe = ie; oe <= ae; oe++) {
            ...
            for (let Je = Ze; Je <= At; Je++) {
              ...
              let Ns = !1, Ls = !1;
              E === I && P === w && H === $ && oe === ie && Je === Ze && (Ns = !0), E === S && P === F && H === U && oe === ae && Je === At && (Ls = !0), o && o(Tc, Bc, Ns, Ls, Wo, he, k, N, y), this._liquid.translateRestore();
            }
...
class Va {
  ...
  getRangePointData(e, t) {
    ...
    for (let v = S; v < i.length; v++) {
      ...
      const { x, y: C } = this._liquid, { left: B } = b;
      for (const y of b.rows)
        if (y.index >= h && y.index <= g) {
          const M = rA(y.cells, u, f);
          if (M == null)
            continue;
          const [w, F] = M, P = {
            startX: x + w.left + B,
...
class Wa {
  ...
  isIntersection(e) {
    ...
    return kc.hasIntersectionBetweenTwoRect(l, A);
  }
  refresh() {
    var p;
    (p = this._rangeShape) == null || p.hide();
    const { startNodePosition: e, endNodePosition: t, _document: o, _docSkeleton: r } = this, s = o.getOffsetConfig(), { docsLeft: i, docsTop: a } = s, d = new Va(s, r).getRangePointData(e, t);
    if (d == null)
      return;
...
var gA = Object.getOwnPropertyDescriptor, fA = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? gA(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, Vn = (n, e) => (t, o) => e(t, o, n);
...
const ko = {
  ...
  handler: (n) => {
    ...
    if (A !== Pe.MODERN) {
      ...
      for (const y in x) {
        ...
        }, oe = g.replaceOp(["drawings", y, "docTransform", "positionV"], F, ae);
        oe && f.push(oe);
      }
    }
  ...
  handler: async (n, e) => {
    ...
    if (S == null)
      return !1;
    const v = new Ie(), R = W.getInstance(), E = [], b = p + 4, x = [{
      startOffset: b,
      endOffset: b,
      collapsed: !0
    }], C = {
    ...
    const B = a.getDefaultStyle(), y = a.getStyleCache(), M = Bo(
      ...
      B,
      y
    ), { dataStream: w, paragraphs: F, sectionBreaks: P } = md(t, o), N = (Ze = (we = (he = (oe = S.parent) == null ? void 0 : oe.parent) == null ? void 0 : he.parent) == null ? void 0 : we.parent) == null ? void 0 : Ze.parent;
    if (N == null)
      return !1;
  ...
  handler: async (n) => {
    ...
    for (const y of m.reverse()) {
      const M = g.removeOp(["tableSource", S, "tableRows", y]);
      E.push(M);
    }
    return x.params.actions = E.reduce((y, M) => W.compose(y, M), null), !!o.syncExecuteCommand(x.id, x.params);
  }
}, Ss = {
  ...
  handler: async (n) => {
    ...
    const x = g.removeOp(["tableSource", I]);
    return v.push(x), E.params.actions = v.reduce((B, y) => W.compose(B, y), null), !!o.syncExecuteCommand(E.id, E.params);
  }
  ...
  handler: async (n, e) => {
    ...
    if (m == null)
      return !1;
    const { offset: I, colCount: S, tableId: v, insertRowIndex: R } = m, E = [], b = I + 2, x = [{
      startOffset: b,
      endOffset: b,
      collapsed: !0
    }], C = {
  ...
  handler: async (n, e) => {
    ...
    if (m == null)
      return !1;
    const { offsets: I, columnIndex: S, tableId: v, rowCount: R } = m, E = [], b = I[0] + 1, x = [{
      startOffset: b,
      endOffset: b,
      collapsed: !0
    }], C = {
    ...
    const y = l.getSnapshot(), M = y.documentStyle, { marginLeft: w = 0, marginRight: F = 0 } = M, P = ((ie = (ne = M.pageSize) == null ? void 0 : ne.width) != null ? ie : 800) - w - F, N = (ae = y == null ? void 0 : y.tableSource) == null ? void 0 : ae[v].tableColumns, { newColWidth: ee, widths: $ } = Cd(P, N, S);
...
function Me({ ref: n, ...e }) {
  const { icon: t, id: o, className: r, extend: s, ...i } = e, a = `univerjs-icon univerjs-icon-${o} ${r || ""}`.trim(), c = ke(`_${bA()}`);
  return Ka(t, `${o}`, {
    defIds: t.defIds,
    idSuffix: c.current
  }, {
...
function Ka(n, e, t, o, r) {
  return Te(n.tag, {
    ...
    ...CA(n, t, r),
    ...o
  }, (RA(n, t).children || []).map((s, i) => Ka(s, `${e}-${n.tag}-${i}`, t, void 0, r)));
}
function CA(n, e, t) {
  const o = { ...n.attrs };
...
ic.displayName = "HorizontallyIcon";
const QA = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
cc.displayName = "LeftJustifyingIcon";
const FA = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
lc.displayName = "RightJustifyingIcon";
const HA = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
dc.displayName = "TodoListDoubleIcon";
function Ac(n) {
  var o;
...
class VA extends me {
  ...
  setDocumentData(t, o) {
    this._commandService.syncExecuteCommand(Da.id, {
...
var WA = Object.getOwnPropertyDescriptor, jA = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? WA(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, Ot = (n, e) => (t, o) => e(t, o, n);
const zA = [
...
let Sr = class extends me {
  ...
  _blurSheetEditor(e) {
    if (zA.some((o) => e.dataset.uComp === o))
      return;
  ...
  blur(e) {
    const t = this.getFocusEditor();
    e && (t == null || t.setSelectionRanges([])), t == null || t.blur(), this._contextService.setContextValue(eo, !1), this._contextService.setContextValue(Us, !1), this._contextService.setContextValue(Fs, !1), this._setFocusId(null), this._blur$.next(null);
  }
  focus(e) {
    ...
    this._contextService.setContextValue(eo, !0), Rt(e) || this._contextService.setContextValue(Us, !0), Vc(e) && this._contextService.setContextValue(Fs, !0), t.focus(), this._setFocusId(e), this._focus$.next({
      startOffset: o,
      endOffset: o
    });
  }
...
const YA = (n) => {
  const e = J(Ye), t = J(L), o = J(pe), r = J(T), s = J(Oo), { unitId: i } = n, a = o.getRenderById(i).with(Re), [c, d] = Ee({}), l = (u, g) => {
    ...
    if (g === "useFirstPageHeaderFooter" && u === !0 && ((S === ve.HEADER && !p.firstPageHeaderId || S === ve.FOOTER && !p.firstPageFooterId) && (v = !0), v && R === 0 && (E = !0)), g === "evenAndOddHeaders" && u === !0 && ((S === ve.HEADER && !p.evenPageHeaderId || S === ve.FOOTER && !p.evenPageFooterId) && (v = !0), v && R % 2 === 1 && (E = !0)), v) {
      ...
      const x = a.getSegmentPage(), C = a.getSegment(), B = GA(
        {
          ...p,
          [g]: u ? z.TRUE : z.FALSE
        },
  ...
  return Ce(() => {
    ...
    /* @__PURE__ */ Q("div", { className: "univer-flex univer-justify-end", children: /* @__PURE__ */ Q($l, { onClick: h, children: e.t("headerFooter.closeHeaderFooter") }) })
  ] });
}, KA = () => {
  var d;
  ...
  }, []), /* @__PURE__ */ Q("div", { className: "univer-text-sm", children: a ? /* @__PURE__ */ Q(YA, { unitId: r }) : /* @__PURE__ */ Q("div", { className: "univer-text-gray-400", children: n.t("headerFooter.disableText") }) });
}, Si = 18, vi = 200, er = 6, qA = 4;
function XA(n, e) {
...
var ZA = Object.getOwnPropertyDescriptor, JA = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ZA(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, ut = (n, e) => (t, o) => e(t, o, n);
...
let Cr = class extends me {
  ...
  _initCustomComponents() {
    this._componentManager.get(vr) || this.disposeWithMe(this._componentManager.register(vr, KA));
  }
  _init() {
  ...
  _initialMain(e) {
    ...
    this.disposeWithMe(o.onDblclick$.subscribeEvent(async (r) => {
      ...
      if (u === g)
        return;
      A.setEditArea(g);
      const { createType: p, headerFooterId: m } = $A(A, g, f);
      if (g === ve.BODY)
        ...
        const S = ge(6);
        this._docSelectionRenderService.setSegment(S), this._docSelectionRenderService.setSegmentPage(f), await this._commandService.executeCommand(uc.id, {
          unitId: e,
          createType: p,
          segmentId: S
        });
...
const $n = "doc.command.core-header-footer", uc = {
  id: $n,
  type: D.COMMAND,
  // eslint-disable-next-line max-lines-per-function
  handler: async (n, e) => {
...
), fc = `${hc}_ORDER_LIST_TYPE_COMPONENT`, pc = `${hc}_BULLET_LIST_TYPE_COMPONENT`, ru = (n) => {
...
function su(n) {
  const { hooks: e } = n, r = J(L).getCurrentUnitOfType(_.UNIVER_DOC).getDocumentStyle(), s = J(Ye), [i, a] = Ee(() => {
    var l, A, h, u, g;
    return {
      paperSize: ru(r.pageSize),
      orientation: (l = r.pageOrient) != null ? l : jc.PORTRAIT,
      margins: {
...
function Iu(n) {
  return {
    ...
    hidden$: Pn(se(n, _.UNIVER_DOC, void 0, nt), au(n), (e, t) => e || t)
  };
}
const Su = "GridIcon", Ec = "doc.menu.table";
function vu(n) {
  return {
    id: Ec,
    type: Z.SUBITEMS,
...
function ot(n) {
  var g, f, p, m;
  const e = n.get(L), t = n.get(Y), o = n.get(at), r = e.getCurrentUnitForType(_.UNIVER_DOC), s = t.getDocRanges(), i = (g = s.find((I) => I.isActive)) != null ? g : s[0], a = o.getDefaultStyle(), c = (f = o.getStyleCache()) != null ? f : {}, d = Vt(n), l = (p = d == null ? void 0 : d.paragraphStyle) != null && p.namedStyleType ? Gc[(m = d == null ? void 0 : d.paragraphStyle) == null ? void 0 : m.namedStyleType] : null;
  if (r == null || i == null)
    return {
      ts: {
        ...a,
...
const Du = {
  ...
  [K.HEADING_1]: { key: "H1Icon", component: tc },
  [K.HEADING_2]: { key: "H2Icon", component: nc },
  [K.HEADING_3]: { key: "H3Icon", component: oc },
  [K.HEADING_4]: { key: "H4Icon", component: rc },
  [K.HEADING_5]: { key: "H5Icon", component: sc },
  ...
  const t = e.get(T), o = e.get(rn), r = Ic[n];
...
}, wu = yt(K.HEADING_1), Pu = yt(K.HEADING_2), Nu = yt(K.HEADING_3), Lu = yt(K.HEADING_4), Qu = yt(K.HEADING_5), Uu = yt(K.NORMAL_TEXT);
yt(K.TITLE);
yt(K.SUBTITLE);
const Fu = (n) => ({
  id: os.id,
...
let Bn = class extends me {
  ...
  _createRectPositionObserver(n, e) {
    const t = () => {
      const { scene: a, engine: c } = e, d = typeof n == "function" ? n() : n, l = c.getCanvasElement(), A = l.getBoundingClientRect(), h = na(l.style.width), u = vc(d, a), { top: g, left: f, width: p } = A, m = p / h;
      return {
        left: u.left * m + f,
        right: u.right * m + f,
        top: u.top * m + g,
...
var qu = Object.getOwnPropertyDescriptor, Xu = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? qu(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, Zu = (n, e) => (t, o) => e(t, o, n);
const Ju = (n, e, t, o) => {
  ...
  _buildCustomRangeBoundsBySegment(e, t = -1) {
    ...
    return o.forEach((c) => {
      const d = {
        ...
        segmentId: e
      }, l = Ju(d, this._documents, this._skeleton, t);
      if (!l)
        return null;
      r.push({
        customRange: c,
          ...
          for (const v of S.columns)
            for (const R of v.lines)
              if (R.paragraphStart) {
                ...
                if (E) {
                  const b = R, x = (p = (f = (g = b == null ? void 0 : b.divides) == null ? void 0 : g[0]) == null ? void 0 : f.glyphGroup) == null ? void 0 : p[0];
                  if (!x)
                    continue;
                  const C = $u(x, this._documents, this._skeleton, t);
                  if (!C)
                    continue;
                  s.push({
                    rect: C,
            ...
            E.cells.forEach((x, C) => {
              ...
              F || (F = [], this._tableCellBounds.set(R, F)), F.push({
                rect: {
                  top: B,
                  left: y,
                  right: y + x.pageWidth - x.marginLeft - x.marginRight,
                  bottom: B + x.pageHeight - x.marginBottom - x.marginTop
                },
                pageIndex: h,
                rowIndex: b,
                colIndex: C,
...
function th(n) {
  const { avaliableMenus: e = eh } = n, t = J(Aa), [o, r] = Ee([]);
  return Ce(() => {
    function s() {
    ...
    "div",
    {
      ...
      children: o.map((s) => s.item && /* @__PURE__ */ Q("div", { className: "univer-flex univer-flex-nowrap univer-gap-2 univer-px-2", children: /* @__PURE__ */ Q(Nl, { ...s.item }, s.key) }, s.key))
    }
  );
}
var nh = Object.getOwnPropertyDescriptor, oh = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? nh(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, ln = (n, e) => (t, o) => e(t, o, n);
...
let co = class extends me {
  ...
  _registerFloatMenu() {
    this.disposeWithMe(this._componentManager.register(Di, th));
  }
  ...
  _showFloatMenu(e, t) {
    ...
    if (t.endOffset - t.startOffset === 1 && r && sh.includes(r))
      return;
    ...
    if (!(s != null && s.some((d) => d.startIndex === t.startOffset && d.endIndex === t.endOffset - 1)))
      return this._floatMenu = {
        disposable: this._docCanvasPopManagerService.attachPopupToRange(
          ...
          {
            componentKey: Di,
            direction: t.direction === "backward" || rh(t.startNodePosition, t.endNodePosition) ? "top-center" : "bottom-center",
            offset: [0, 4]
          },
          e
        ),
...
var ih = Object.getOwnPropertyDescriptor, ah = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ih(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, dn = (n, e) => (t, o) => e(t, o, n);
  ...
  showParagraphMenu(e) {
    ...
    const a = this._docPopupManagerService.attachPopupToRect(
      e.firstLine,
      {
        ...
        onClickOutside: () => {
          this._docSelectionManagerService.textSelection$.pipe(Gl()).subscribe(() => {
...
const ch = ({ popup: n }) => {
  ...
  return /* @__PURE__ */ re(Jl, { children: [
    /* @__PURE__ */ re(
      "div",
      {
      ...
      Ql,
      {
        ...
        children: /* @__PURE__ */ Q(
          "section",
          {
            ...
            onMouseEnter: (x) => {
              var C;
              (C = n.onPointerEnter) == null || C.call(n, x), a.current = !0;
            },
            onMouseLeave: () => {
              a.current = !1;
            },
...
const dh = {
  ...
  preconditions: Se
}, Vo = "docs-ui.config", wi = {
  layout: {
    docContainerConfig: sd,
    toolbarConfig: rd
  }
}, bh = [50, 80, 100, 130, 150, 170, 200, 400], xh = [10, 400];
function yh() {
  const n = J(T), e = J(L), t = _e(() => e.getCurrentTypeOfUnit$(_.UNIVER_DOC), []), o = et(t), r = ga(() => {
    var d, l;
    if (!o) return 100;
...
const Bh = "univer-font-[500] univer-truncate univer-h-[24px] univer-mb-2 univer-leading-[24px] univer-cursor-pointer univer-pr-1 ", Mh = "univer-text-base univer-font-semibold", _h = "univer-text-sm univer-font-semibold", Dh = "univer-text-sm", wh = Be((n, e) => {
  ...
  const S = _e(() => ({
    scrollTo: (v) => {
      ...
      if (!E) return;
      const b = E.offsetTop, x = m.current.clientHeight, C = m.current.scrollHeight - x, B = Math.max(0, Math.min(b - x / 2 + E.clientHeight / 2, C));
      (y = m.current) == null || y.scrollTo({
        behavior: "smooth",
        top: B
      });
    }
  ...
  return ql(e, () => S), Ce(() => {
    ...
    /* @__PURE__ */ Q(
      "div",
      {
        ...
        style: f,
        children: d ? /* @__PURE__ */ Q(ac, {}) : /* @__PURE__ */ Q(Xa, {})
      }
    ),
    /* @__PURE__ */ Q(
      "div",
      {
        ...
        children: /* @__PURE__ */ Q(
          ...
          {
            ref: m,
            className: ze("univer-flex-1 univer-overflow-y-auto univer-overflow-x-hidden", ed),
...
function Lh() {
  var e, t, o;
  const n = ua(Vo);
  return (o = (t = (e = n == null ? void 0 : n.layout) == null ? void 0 : e.docContainerConfig) == null ? void 0 : t.sideMenu) == null || o ? /* @__PURE__ */ Q(Qh, {}) : null;
}
function Qh() {
  var B, y, M, w, F, P, N, ee, $;
  const n = J(T), e = J(L), t = et(_e(() => e.getCurrentTypeOfUnit$(_.UNIVER_DOC), [])), o = J(pe), r = (y = (B = t == null ? void 0 : t.getBody()) == null ? void 0 : B.dataStream) != null ? y : "", [s, i] = Ee(0), [a, c] = Ee(void 0), d = (M = t == null ? void 0 : t.getUnitId()) != null ? M : "", l = o.getRenderById(d), A = t == null ? void 0 : t.getTitle(), h = l == null ? void 0 : l.with(Pt), u = h == null ? void 0 : h.paragraphBounds, g = (F = (w = l == null ? void 0 : l.mainComponent) == null ? void 0 : w.left) != null ? F : 0, f = (P = l == null ? void 0 : l.engine.height) != null ? P : 0, p = (N = l == null ? void 0 : l.scene.scaleY) != null ? N : 1, m = ($ = (ee = t == null ? void 0 : t.getBody()) == null ? void 0 : ee.paragraphs) != null ? $ : [], I = _e(() => {
    const U = /* @__PURE__ */ new Map();
    return m.forEach((H) => {
      U.set(H.startIndex, H);
    }), U;
  }, [m]);
  et(_e(() => l != null && l.engine.onTransformChange$ ? Mt(l == null ? void 0 : l.engine.onTransformChange$).pipe(Rn(33)) : Yl(null), [l == null ? void 0 : l.engine.onTransformChange$]));
  const S = g < 180 ? "float" : "side-bar", v = m == null ? void 0 : m.filter(
    ...
    var ae;
    const H = Ph(U.paragraphStyle.namedStyleType), k = u == null ? void 0 : u.get(U.startIndex);
    if (!k) return null;
    ...
    const H = U.viewportScrollY, k = H + f / p, ne = Nh(u, I, H, k);
    ne && c(ne);
...
const rt = {
  ...
  var c, d, l, A, h;
  const e = J(L).getCurrentUnitForType(_.UNIVER_DOC), t = Uh();
  if (!e || t.length === 0)
    return [];
  ...
  return Ce(() => {
    const u = s.pipe(
      ...
      Xl(16),
      dr((g) => !!g.length),
      Zl((g) => g.reduce((f, p) => (Object.keys(p).forEach((m) => {
        f[m] = p[m];
      }), f), {}))
...
function Kh() {
  const n = J(Ye), e = _e(() => [
    { label: n.t("toolbar.alignLeft"), value: String(Ue.LEFT), icon: /* @__PURE__ */ Q(cc, {}) },
  ...
  ], []), t = Fh(), [o, r] = Hh(t, e[0].value), [s, i] = kh(t), [a, c] = Vh(t), [d, l] = Wh(t), [A, h] = jh(t), [u, g] = zh(t), [f, p] = Gh(t), { lineSpacing: [m, I], spacingRule: [S, v] } = Yh(t), R = _e(() => S === Xt.AUTO ? { min: 1, max: 5, step: m < 2 ? 0.5 : 1 } : { min: 1, max: 100 }, [S, m]);
...
const qh = (n, e) => e.length === n.length && n.some((t) => e.some((o) => o.startOffset === t.startOffset && o.endOffset === t.endOffset));
function Xh() {
  ...
  return Ce(() => {
    const a = n.onCommandExecuted((c) => {
      if (Le.id === c.id) {
        ...
        qh(d, i.current) || r(ge(4)), i.current = d;
      }
    ...
    r(ge(4));
  }, [t]), Ce(() => () => s.cancel(), [s]), /* @__PURE__ */ Q(Kh, {}, o);
}
var Zh = Object.getOwnPropertyDescriptor, Jh = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Zh(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, or = (n, e) => (t, o) => e(t, o, n);
...
let tn = class extends me {
  ...
  _init() {
    this.disposeWithMe(this._componentManager.register(Ni, Xh));
  }
  openPanel() {
    const e = {
...
let Ao = class extends me {
  ...
  _initCustomComponents() {
    [
      [pc, ou],
      [fc, tu],
      ["TodoListDoubleIcon", dc],
      ["doc.paragraph.menu", ch],
      ["CutIcon", Za],
      ["DeleteIcon", Ja],
      [Rr, su],
  ...
  _initUiParts() {
    this.disposeWithMe(this._uiPartsService.registerComponent(qs.FOOTER, () => Xs(Th, this._injector))), this.disposeWithMe(this._uiPartsService.registerComponent(qs.CONTENT, () => Xs(Lh, this._injector)));
  }
  _initMenus() {
    this._menuManagerService.mergeMenu(gg);
  }
  _initShortCut() {
    [
      uh,
...
let uo = class extends Ct {
  ...
  scrollToNode(n) {
    ...
    const x = f.transViewportScroll2ScrollValue(E, R);
    f.scrollByBarDeltaValue(x);
  }
...
var Ig = Object.getOwnPropertyDescriptor, Sg = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ig(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, zt = (n, e) => (t, o) => e(t, o, n);
let br = class extends Ct {
  ...
  _addNewRender() {
    const { scene: n, engine: e } = this._context, t = new gl(We.VIEW_MAIN, n, {
      left: 0,
      top: 0,
      bottom: 0,
      right: 0,
  ...
  _addComponent() {
    const { scene: n, unit: e, components: t } = this._context, s = {
      pageMarginLeft: 20,
      pageMarginTop: 20
    }, i = new fl($e.MAIN, void 0, s);
    i.zIndex = $s;
    const a = new pl($e.BACKGROUND, void 0, s);
    a.zIndex = $s, this._context.mainComponent = i, t.set($e.MAIN, i), t.set($e.BACKGROUND, a), n.addObjects([i], zo), n.addObjects([a], ad), this._editorService.getEditor(e.getUnitId()) == null && n.enableLayerCache(zo);
  }
  _initRenderRefresh() {
...
var bg = Object.getOwnPropertyDescriptor, xg = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? bg(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, yg = (n, e) => (t, o) => e(t, o, n);
...
var Og = Object.getOwnPropertyDescriptor, Tg = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Og(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, Ui = (n, e) => (t, o) => e(t, o, n);
...
var Ng = Object.getOwnPropertyDescriptor, Lg = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ng(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, jn = (n, e) => (t, o) => e(t, o, n);
let fo = class extends me {
  ...
  _handleShiftMoveSelection(e) {
    ...
    if (o.length > 1) {
      ...
      for (const x of o)
        E = Math.min(E, x.startOffset), b = Math.max(b, x.endOffset);
    ...
    if (e === le.LEFT || e === le.RIGHT) {
      ...
      const E = s.findNodeByCharIndex(m, h, f), b = i.document.getOffsetConfig(), x = l ? u : A === De.FORWARD ? g : u, C = this._getTopOrBottomPosition(s, E, x, e === le.DOWN, !0);
      if (C == null) {
        const y = e === le.UP ? 0 : I - 2;
        if (y === m)
          return;
        this._textSelectionManagerService.replaceTextRanges([
          {
  ...
  _handleMoveCursor(e) {
    ...
    if (e === le.LEFT || e === le.RIGHT) {
      ...
      if (!t.collapsed || o.length > 1) {
        ...
        for (const y of o)
          C = Math.min(C, y.startOffset), B = Math.max(B, y.endOffset);
        E = e === le.LEFT ? C : B;
      } else {
        const C = s.findNodeByCharIndex(a - 1, A, g), B = s.findNodeByCharIndex(a, A, g), y = s.findNodeByCharIndex(a + 1, A, g);
        e === le.LEFT ? E = Math.max(0, a - ((R = C == null ? void 0 : C.count) != null ? R : 1)) : E = Math.min(p - 2, c + B.count + ((y == null ? void 0 : y.streamType) === V.SECTION_BREAK ? 1 : 0));
      }
      const b = [
        V.TABLE_START,
        V.TABLE_END,
      ...
      const E = s.findNodeByCharIndex(a, A, g), b = s.findNodeByCharIndex(c, A, g), x = i.document.getOffsetConfig(), C = this._getTopOrBottomPosition(
        s,
        e === le.UP || l ? E : b,
        e === le.UP || l ? h : u,
        e === le.DOWN
      ...
      if (C == null) {
        let y;
        l ? y = e === le.UP ? 0 : p - 2 : y = e === le.UP ? a : c, this._textSelectionManagerService.replaceTextRanges([
          {
            startOffset: Math.max(0, y),
            endOffset: Math.max(0, y),
            style: d
          }
        ], !1);
        return;
      }
      const B = new It(x, s).getRangePointData(
        C,
        C
      ).cursorList[0];
      this._textSelectionManagerService.replaceTextRanges([
  ...
  _getNextOrPrevLine(e, t, o = !1) {
    ...
    if (t === !0)
      ...
      const y = (m = (p = a.columns) == null ? void 0 : p[A - 1]) == null ? void 0 : m.lines;
    ...
    if (g !== -1) {
      if (t === !0)
        l = (x = (b = (E = u.pages[g + 1]) == null ? void 0 : E.sections[0]) == null ? void 0 : b.columns[0]) == null ? void 0 : x.lines[0];
      else {
  ...
  _getDocObject() {
    return ld(this._univerInstanceService, this._renderManagerService);
  }
};
fo = Lg([
  jn(0, L),
...
let po = class extends me {
  ...
  _initCustomComponents() {
    ...
    this.disposeWithMe(n.register(Ya, Qg));
  }
  _init() {
  }
};
...
let yr = class extends me {
  ...
  _initPointerDownObserver() {
    this._docEventManagerService.clickBullets$.subscribe((n) => {
      ...
      this._commandService.executeCommand(Na.id, {
...
let mo = class extends Ct {
  ...
  _initLegacyPasteCommand() {
    ...
    (n = this._docSelectionRenderService) == null || n.onPaste$.pipe(ft(this.dispose$)).subscribe((e) => {
      ...
      const r = (c = t.clipboardData) == null ? void 0 : c.getData(aa), s = [...((d = t.clipboardData) == null ? void 0 : d.items) || []].filter((l) => Vl.has(l.type)).map((l) => l.getAsFile()).filter((l) => !!l);
...
var jg = Object.getOwnPropertyDescriptor, zg = (n, e, t, o) => {
...
let Or = class extends me {
  constructor(n, e, t) {
    super(), this._context = n, this._contextMenuService = e, this._commandService = t, Gg.includes(this._context.unitId) || (this._initPointerDown(), this._initEditChange());
  }
  _initPointerDown() {
    var t, o;
...
var of = Object.getOwnPropertyDescriptor, rf = (n, e, t, o) => {
...
const sf = Ji("PRINTING_COMPONENT_COLLECT"), af = Ji("PRINTING_DOM_COLLECT");
class cf extends me {
  constructor() {
    super();
    O(this, "_printComponentMap", /* @__PURE__ */ new Map());
    O(this, "interceptor", new Xc({
      PRINTING_COMPONENT_COLLECT: sf,
      PRINTING_DOM_COLLECT: af
    }));
...
var Af = Object.getOwnPropertyDescriptor, uf = (n, e, t, o) => {
...
var xf = Object.defineProperty, yf = Object.getOwnPropertyDescriptor, Of = (n, e, t) => e in n ? xf(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Tf = (n, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? yf(e, t) : e, s = n.length - 1, i; s >= 0; s--)
    (i = n[s]) && (r = i(r) || r);
  return r;
}, hn = (n, e) => (t, o) => e(t, o, n), Bf = (n, e, t) => Of(n, e + "", t);
let wr = class extends Jc {
...
const $f = (n) => {
  ...
  const {
    ...
    editorRef: p,
    placeholder: m
  } = n, I = J(Ge), S = mn(o), v = mn(s), [R, E] = Ee(u), b = ke(null), x = _e(() => l != null ? l : tl(`RICH_TEXT_EDITOR-${ge(4)}`), [l]), C = Df({
    editorId: x,
    initialValue: r,
    container: b,
    autoFocus: t,
  ...
  }, [C, x, I, v]), wf(F && a, !1, C), Mf(F, i, C), Pf(C, U), /* @__PURE__ */ Q("div", { className: e, style: c, children: /* @__PURE__ */ re(
    "div",
    {
...
export {
  ...
  cf as DocPrintInterceptorService,
  ...
  Xf as hasParagraphInTable,
  Ha as isInSameTableCell,
  oA as isValidRectRange,
  pt as neoGetDocObject,
  Jf as transformToDocDrawingPosition,
  Mf as useKeyboardEvent,
  _f as useResize,
