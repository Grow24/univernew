...
import { createIdentifier as k, ICommandService as b, UniverInstanceType as u, IUniverInstanceService as L, ILogService as ee, RxDisposable as W, Inject as C, Injector as R, toDisposable as te, CommandType as H, Disposable as ne, IConfigService as A, Plugin as V, merge as F } from "@univerjs/core";
...
const me = "rpc.main-thread.config", $ = {}, ye = "rpc.worker-thread.config", j = {};
function fe() {
  return {
    send(s) {
      postMessage(s);
...
let N = (P = class extends V {
  constructor(t = $, e, n) {
    ...
    this._configService.setConfig(me, r);
  }
  dispose() {
