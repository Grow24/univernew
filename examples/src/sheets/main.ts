...
function createNewInstance() {
    ...
    // create univer sheet instance with blank workbook
    if (!IS_E2E) {
        // Create a blank workbook with one empty sheet
        const blankWorkbook: IWorkbookData = {
            id: '',
            sheetOrder: ['sheet-01'],
            name: '',
            appVersion: '0.12.4',
        ...
        univer.createUnit(UniverInstanceType.UNIVER_SHEET, blankWorkbook);
    }
