(() => {
      ...
      (function(CSS) {
        ...
        function parse(css) {
          ...
          if (css.startsWith("rgba(")) {
            ...
            const a = parseFloat((_h = (_g = color.groups) == null ? void 0 : _g.a) != null ? _h : "0");
  ...
  // ../node_modules/.pnpm/monaco-editor@0.55.1/node_modules/monaco-editor/esm/vs/editor/editor.worker.js
  self.onmessage = () => {
