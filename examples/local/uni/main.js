...
function FakeFontFamilySelectorMenuItemFactory() {
  return {
...
function FakeFontSizeSelectorMenuItemFactory() {
  return {
...
function FakeTextColorSelectorMenuItemFactory() {
  return {
...
function FakeBackgroundColorSelectorMenuItemFactory() {
  return {
...
function FakeUnorderListMenuItemFactory() {
  return {
...
function FakeOrderListMenuItemFactory() {
  return {
...
function FakeFontGroupMenuItemFactory() {
  return {
...
function FakePivotTableMenuItemFactory() {
  return {
...
function DownloadMenuItemFactory() {
  return {
    id: DOWNLOAD_MENU_ID,
    type: 0 /* BUTTON */,
    title: "",
...
function DeleteMenuItemFactory() {
  return {
    id: DELETE_MENU_ID,
    type: 0 /* BUTTON */,
    title: "Delete",
...
// ../node_modules/.pnpm/@xyflow+react@12.9.3_@types+react@19.2.7_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/@xyflow/react/dist/esm/index.js
...
function calculateNodePosition({ nodeId, nextPosition, nodeLookup, nodeOrigin = [0, 0], nodeExtent, onError }) {
  ...
  return {
    position: {
      x: positionAbsolute.x - parentX + ((_b = node.measured.width) != null ? _b : 0) * origin[0],
      y: positionAbsolute.y - parentY + ((_c = node.measured.height) != null ? _c : 0) * origin[1]
    },
    positionAbsolute
  };
}
...
var getViewportForBounds = (bounds, width, height, minZoom, maxZoom, padding) => {
  ...
  return {
    x: x - offset2.left + offset2.right,
    y: y - offset2.top + offset2.bottom,
    zoom: clampedZoom
  };
};
var isMacOs = () => {
...
function getPoints({ source, sourcePosition = Position.Bottom, target, targetPosition = Position.Top, center, offset: offset2, stepPosition }) {
  ...
  if (sourceDir[dirAccessor] * targetDir[dirAccessor] === -1) {
    if (dirAccessor === "x") {
      centerX = (_a = center.x) != null ? _a : sourceGapped.x + (targetGapped.x - sourceGapped.x) * stepPosition;
      centerY = (_b = center.y) != null ? _b : (sourceGapped.y + targetGapped.y) / 2;
    } else {
      centerX = (_c = center.x) != null ? _c : (sourceGapped.x + targetGapped.x) / 2;
...
function parseHandles(userNode, internalNode) {
  ...
  for (const handle of userNode.handles) {
    const handleBounds = {
      id: handle.id,
      width: (_a = handle.width) != null ? _a : 1,
      height: (_b = handle.height) != null ? _b : 1,
      nodeId: userNode.id,
      x: handle.x,
      y: handle.y,
...
// ../node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.7_react@19.2.0/node_modules/zustand/esm/traditional.mjs
var import_react = __toESM(require_react(), 1);
var import_with_selector = __toESM(require_with_selector(), 1);

// ../node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.7_react@19.2.0/node_modules/zustand/esm/vanilla.mjs
...
// ../node_modules/.pnpm/zustand@4.5.7_@types+react@19.2.7_react@19.2.0/node_modules/zustand/esm/shallow.mjs
...
function useKeyPress(keyCode = null, options = { target: defaultDoc, actInsideInputWithModifier: true }) {
  ...
  (0, import_react2.useEffect)(() => {
    var _a, _b;
    const target = (_a = options == null ? void 0 : options.target) != null ? _a : defaultDoc;
    const actInsideInputWithModifier = (_b = options == null ? void 0 : options.actInsideInputWithModifier) != null ? _b : true;
    if (keyCode !== null) {
      const downHandler = (event) => {
        ...
        if (isMatchingKey(keyCodes, pressedKeys.current, false)) {
          const target2 = ((_b2 = (_a2 = event.composedPath) == null ? void 0 : _a2.call(event)) == null ? void 0 : _b2[0]) || event.target;
  ...
  return (0, import_react2.useMemo)(() => {
    return {
      ...
      screenToFlowPosition: (clientPosition, options = {}) => {
        ...
        const _snapGrid = (_a = options.snapGrid) != null ? _a : snapGrid;
        const _snapToGrid = (_b = options.snapToGrid) != null ? _b : snapToGrid;
  ...
  const generalHelper = (0, import_react2.useMemo)(() => {
    ...
    return {
      ...
      getHandleConnections: ({ type, id: id2, nodeId }) => {
        var _a, _b;
        return Array.from((_b = (_a = store.getState().connectionLookup.get(`${nodeId}-${type}${id2 ? `-${id2}` : ""}`)) == null ? void 0 : _a.values()) != null ? _b : []);
      },
      getNodeConnections: ({ type, handleId, nodeId }) => {
        var _a, _b;
        return Array.from((_b = (_a = store.getState().connectionLookup.get(`${nodeId}${type ? handleId ? `-${type}-${handleId}` : `-${type}` : ""}`)) == null ? void 0 : _a.values()) != null ? _b : []);
      },
      fitView: async (options) => {
        var _a;
        const fitViewResolver = (_a = store.getState().fitViewResolver) != null ? _a : withResolvers();
...
function useResizeHandler(domNode) {
  ...
  (0, import_react2.useEffect)(() => {
    const updateDimensions = () => {
      var _a, _b, _c, _d, _e;
      if (!domNode.current || !((_c = (_b = (_a = domNode.current).checkVisibility) == null ? void 0 : _b.call(_a)) != null ? _c : true)) {
        return false;
      }
      const size = getDimensions(domNode.current);
      if (size.height === 0 || size.width === 0) {
        (_e = (_d = store.getState()).onError) == null ? void 0 : _e.call(_d, "004", errorMessages["error004"]());
      }
...
function Pane({ isSelecting, selectionKeyPressed, selectionMode = SelectionMode.Full, panOnDrag, paneClickDistance, selectionOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children: children2 }) {
  ...
  const onPointerMove = (event) => {
    ...
    const edgesSelectable = (_a = defaultEdgeOptions == null ? void 0 : defaultEdgeOptions.selectable) != null ? _a : true;
...
function NodeWrapper({ id: id2, onClick, onMouseEnter, onMouseMove, onMouseLeave, onContextMenu, onDoubleClick, nodesDraggable, elementsSelectable, nodesConnectable, nodesFocusable, resizeObserver, noDragClassName, noPanClassName, disableKeyboardA11y, rfId, nodeTypes, nodeClickDistance, onError }) {
  ...
  const onFocus = () => {
    var _a2;
    if (disableKeyboardA11y || !((_a2 = nodeRef.current) == null ? void 0 : _a2.matches(":focus-visible"))) {
      return;
    }
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: cc([
    ...
    ...node.style,
    ...inlineDimensions
  }, "data-id": id2, "data-testid": `rf__node-${id2}`, onMouseEnter: onMouseEnterHandler, onMouseMove: onMouseMoveHandler, onMouseLeave: onMouseLeaveHandler, onContextMenu: onContextMenuHandler, onClick: onSelectNodeHandler, onDoubleClick: onDoubleClickHandler, onKeyDown: isFocusable ? onKeyDown : void 0, tabIndex: isFocusable ? 0 : void 0, onFocus: isFocusable ? onFocus : void 0, role: (_a = node.ariaRole) != null ? _a : isFocusable ? "group" : void 0, "aria-roledescription": "node", "aria-describedby": disableKeyboardA11y ? void 0 : `${ARIA_NODE_DESC_KEY}-${rfId}`, "aria-label": node.ariaLabel, ...node.domAttributes, children: (0, import_jsx_runtime.jsx)(Provider, { value: id2, children: (0, import_jsx_runtime.jsx)(NodeComponent, { id: id2, data: node.data, type: nodeType, positionAbsoluteX: internals.positionAbsolute.x, positionAbsoluteY: internals.positionAbsolute.y, selected: (_b = node.selected) != null ? _b : false, selectable: isSelectable, draggable: isDraggable, deletable: (_c = node.deletable) != null ? _c : true, isConnectable, sourcePosition: node.sourcePosition, targetPosition: node.targetPosition, dragging, dragHandle: node.dragHandle, zIndex: internals.z, parentId: node.parentId, ...nodeDimensions }) }) });
}
...
var getInitialState = ({ nodes, edges, defaultNodes, defaultEdges, width, height, fitView, fitViewOptions, minZoom = 0.5, maxZoom = 2, nodeOrigin, nodeExtent } = {}) => {
  ...
  if (fitView && width && height) {
    ...
    const { x, y, zoom } = getViewportForBounds(bounds, width, height, minZoom, maxZoom, (_c = fitViewOptions == null ? void 0 : fitViewOptions.padding) != null ? _c : 0.1);
    transform2 = [x, y, zoom];
  }
  return {
    rfId: "1",
    ...
    fitViewQueued: fitView != null ? fitView : false,
    fitViewOptions,
        ...
        if (expandParent && node.parentId) {
          parentExpandChildren.push({
            ...
            rect: {
              ...
              width: (_a = dragItem.measured.width) != null ? _a : 0,
              height: (_b = dragItem.measured.height) != null ? _b : 0
            }
          });
        }
        changes.push(change);
...
function MiniMapComponent({
  ...
  const _ariaLabel = ariaLabel != null ? ariaLabel : ariaLabelConfig["minimap.ariaLabel"];
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = void 0, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, resizeDirection, autoScale = true, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  const controlPosition = position != null ? position : defaultPositions[variant];
  (0, import_react2.useEffect)(() => {
      ...
      resizer.current = XYResizer({
        ...
        onChange: (change, childChanges) => {
          ...
          if (node && node.expandParent && node.parentId) {
            const origin = (_a = node.origin) != null ? _a : nodeOrigin;
            const width = (_c = (_b = change.width) != null ? _b : node.measured.width) != null ? _c : 0;
            const height = (_e = (_d = change.height) != null ? _d : node.measured.height) != null ? _e : 0;
            const child = {
              id: node.id,
              parentId: node.parentId,
              rect: {
                ...
                ...evaluateAbsolutePosition({
                  x: (_f = change.x) != null ? _f : node.position.x,
                  y: (_g = change.y) != null ? _g : node.position.y
...
var UniFloatingToolbar = (0, import_react4.forwardRef)(({ node }, ref) => {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "univer-flex", children: uniVisibleItems.map((subItem) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ToolbarItem, { ...subItem }, subItem.id)) })
          ]
        }
      )
    }
...
function UniDiv() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "univer-h-6 univer-w-px univer-bg-gray-100" });
}
...
var UniControlButton = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Tooltip, { title: tooltips, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    Button,
    {
      variant: "text",
...
var UniControls = ({ zoom, onItemClick }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      className: clsx(`univer-fixed univer-bottom-3 univer-right-3 univer-flex univer-w-fit univer-items-center univer-gap-3 univer-rounded-[10px] univer-bg-white univer-p-2 univer-shadow`, borderClassName),
      style: { right: `${rightPadding}px` },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UniControlButton, { tooltips: "Full screen", onClick: onFullscreenHandler, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FullscreenIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UniControlButton, { tooltips: "Zoom in", onClick: onZoomInHandler, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(IncreaseIcon, {}) }),
          ...
          Dropdown,
          {
            overlay: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "div",
              {
                ...
                children: shortcuts == null ? void 0 : shortcuts.map((item) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                  "a",
                  {
                    className: clsx(`univer-relative univer-box-border univer-cursor-pointer univer-rounded univer-py-1 univer-pl-9 univer-text-gray-900 univer-no-underline univer-transition-colors univer-duration-200 hover:univer-bg-gray-100 dark:!univer-text-white dark:hover:!univer-bg-gray-700`, item === zoomPercent ? "univer-bg-gray-100" : ""),
                    onClick: () => onZoomMenuChange(item),
                    children: [
                      item === zoomPercent && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                        "span",
                        {
                          className: `univer-absolute univer-left-1 univer-top-0 univer-flex univer-h-full univer-items-center univer-text-green-600`,
                          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckMarkIcon, {})
                        }
                      ),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UniControlButton, { tooltips: "Zoom out", onClick: onZoomOutHandler, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ZoomReduceIcon, {}) }),
...
function UniSidebar(props) {
  ...
  const width = (0, import_react7.useMemo)(() => {
    if (!(options == null ? void 0 : options.visible)) return "0px";
  ...
  function handleClose() {
    ...
    (_a2 = options2 == null ? void 0 : options2.onClose) == null ? void 0 : _a2.call(options2);
  }
  const visible = (_a = options == null ? void 0 : options.visible) != null ? _a : false;
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "aside",
    {
      className: clsx(`univer-pointer-events-auto univer-fixed univer-bottom-3 univer-top-12 univer-z-20 univer-box-border univer-overflow-hidden univer-rounded-lg univer-shadow-lg univer-transition-all`, borderClassName, {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        ...
        {
          ref: scrollRef,
          className: clsx(`univer-m-auto univer-box-border univer-flex univer-h-0 univer-min-h-full univer-w-full univer-flex-col univer-overflow-hidden univer-overflow-y-auto univer-bg-white`, scrollbarClassName),
          children: [
            showClose && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "header",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("a", { className: "univer-cursor-pointer", onClick: handleClose, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CloseIcon, {}) })
                ]
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "section",
              {
                ...
                children: options == null ? void 0 : options.children
              }
            ),
            (options == null ? void 0 : options.footer) && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("footer", { className: "univer-sticky univer-bottom-0 univer-box-border univer-p-4", children: options.footer })
          ]
        }
      )
    }
...
var UniFormulaBar = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "div",
      {
        className: clsx(`univer-flex univer-cursor-pointer univer-items-center univer-gap-2 univer-rounded-md univer-border-primary-400 univer-bg-primary-300 univer-px-3 univer-py-1.5 univer-text-sm univer-text-primary-600`, {
          "univer-opacity-30": !focusedId
        }),
        onClick: () => handleOpenWrite(),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FxIcon, {}),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "univer-whitespace-nowrap univer-text-xs", children: "Write formula" })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "div",
      {
        className: clsx(`dark:!univer-bg-dark univer-absolute univer-left-0 univer-top-0 univer-z-10 univer-h-full univer-w-full univer-bg-white`, {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button, { size: "small", variant: "text", className: "univer-text-red-600", onClick: handleCloseBtnClick, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CloseIcon, {}) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button, { size: "small", variant: "text", className: "univer-text-green-600", onClick: handleConfirmBtnClick, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CheckMarkIcon, {}) })
            ]
          }
        ),
        FormulaEditor && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          FormulaEditor,
          {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "univer-flex univer-shrink-0 univer-items-center univer-gap-1", children: uniVisibleItems.map((subItem) => subItem && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToolbarItem, { ...subItem }, subItem.id)) })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ConfigProvider, { locale: locale == null ? void 0 : locale.design, mountContainer: portalContainer, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(ReactFlowProvider, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "univer-absolute univer-left-0 univer-top-0 univer-h-full univer-w-full", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
            "section",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  index,
                  {
                    ...
                    onPointerDown: (event) => {
                      if (event.target instanceof HTMLElement && (event.target.dataset.uComp === "render-canvas" || event.target.classList.contains("react-flow__resize-control"))) {
                        return;
                      }
              ...
              children: [
                header && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "univer-pointer-events-auto univer-max-w-[calc(100%-650px)]", children: [
...
function UnitNode({ data }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "univer-relative univer-flex univer-h-full univer-w-full", onPointerDownCapture: focus, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(MenuIcon, {})
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "div",
...
function UnitRenderer(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    "div",
    {
      className: clsx(`univer-relative univer-flex-1 univer-overflow-hidden univer-rounded-lg univer-border-transparent`, borderClassName, {
...
function Outline() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ComponentContainer, { components: outlineComponent }, "outline");
}
...
// ../packages-experimental/uni-docs-ui/src/controllers/uni-docs-ui.controller.ts
...
function UniSheetBar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "univer-flex univer-h-full univer-select-none univer-flex-col univer-justify-between", ref: sheetBarRef, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: clsx("univer-overflow-y-auto", scrollbarClassName), children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "univer-flex univer-flex-col univer-gap-1 univer-text-sm univer-font-medium", children: sheetList.map((item, index2) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "div",
      {
        className: clsx(`univer-flex univer-h-8 univer-cursor-pointer univer-items-center univer-rounded-lg univer-px-1 univer-py-0 hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700`, activeKey === item.sheetId ? "univer-text-primary-500" : ""),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IncreaseIcon, { className: "univer-mr-1 univer-size-4" }),
...
function UniSlideSideBar() {
  ...
  const divRefs = (0, import_react13.useMemo)(() => slideList.map(() => (0, import_react13.createRef)()), [slideList]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "univer-flex univer-h-full univer-select-none univer-flex-col", ref: slideBarRef, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "div",
      {
        className: clsx("univer-overflow-y-auto", scrollbarClassName),
        style: { height: `${barHeight}px` },
        children: slideList.map((item, index2) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          "div",
          {
            className: clsx(`univer-relative univer-my-4 univer-box-border univer-flex univer-w-[160px] univer-overflow-hidden univer-rounded-lg hover:univer-border-primary-600`, borderClassName, item.id === activatePageId && "univer-border-primary-600"),
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { ref: divRefs[index2], className: "univer-relative univer-h-[90px] univer-w-[160px]" })
            ]
          },
          item.id
        ))
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(IncreaseIcon, { className: "univer-mr-1 univer-size-4" }),
